...
<Aside>
  View live values on [Tonscan](https://tonscan.org/config) or [Tonviewer](https://tonviewer.com/config).
</Aside>
...
The parameter values in the [current configuration](https://tonviewer.com/config), and the method of writing them into [cells](/foundations/serialization/boc) are outlined in the [`block.tlb`](https://github.com/ton-blockchain/ton/blob/master/crypto/block/block.tlb) file in [TL-B](/languages/tl-b/overview) format.
...
// Root TON DNS resolver
_dns_root_addr: bits256 = ConfigParam 4;

// Current network and TVM version
capabilities#c4 version:uint32 capabilities:uint64 = GlobalVersion;
_GlobalVersion = ConfigParam 8; // all zeros if absent
```
