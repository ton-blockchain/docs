...
If you are wondering about changing blockchain config in local test setup (e.g. in Sandbox), you can read about it [here](/ecosystem/blueprint/reference#updateconfig).
