...
The recommended programming language for smart contract development in TON is [Tolk](/tolk/overview). Other established languages also exist and are still used, albeit in a legacy status.
...
For on-chain software, use [Acton](/contract-dev/acton) — a recommended modern all-in-one Tolk smart contract development environment.
