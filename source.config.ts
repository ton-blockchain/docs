...
export const docs = defineDocs({
  ...
  docs: {
    schema: pageSchema
      .extend({
        /** Internal metadata generated by Fumadocs AsyncAPI. */
        _asyncapi: z.record(z.string(), z.unknown()).optional(),
        /** Sidebar-only title, which is usually shorter than the main one. */
      ...
      .transform((frontmatter) => ({
        ...frontmatter,
        // NOTE: A tag or url must not be used with an API tag specified in the frontmatter
        ...(frontmatter._openapi || frontmatter._asyncapi
          ? { tag: undefined, url: undefined }
          : {}),
      })),
    postprocess: {
