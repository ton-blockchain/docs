    ...
    <div className="flex flex-col gap-4">
      ...
      >
       <JourneyStep
          ...
          href="/contract-dev/acton"
        >
        </JourneyStep>
        <JourneyStep
          title="JetBrains IDE plugin"
          href="/contract-dev/ide/jetbrains"
        >
        </JourneyStep>
        <JourneyStep
          title="VS Code extension"
          href="/contract-dev/ide/vscode"
        >
        </JourneyStep>
        <JourneyStep
      ...
      >
        ...
        <JourneyStep
          ...
          iconType="solid"
          href="/ecosystem/ton-pay/overview"
        >
        </JourneyStep>
        <JourneyStep
          title="Integrate wallets with WalletKit"
          iconType="solid"
