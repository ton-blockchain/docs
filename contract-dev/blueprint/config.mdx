...
Create a `blueprint.config.ts` file in the root of the project, and export the configuration as a named `config`. Do **not** use a `default` export. Instead, prefer granular export:
