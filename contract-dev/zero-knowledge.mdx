...
<Aside>
  ...
  For repo-backed examples from [`zk-examples/zk-ton-examples`](https://github.com/zk-examples/zk-ton-examples/) covering Circom, Noname, Gnark, and Arkworks, see [Groth16 verification examples](/contract-dev/privacy-zk/groth16-examples).
</Aside>
