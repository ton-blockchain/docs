...
Most development is done in the [Tolk](/languages/tolk/overview), a high-level programming language. Its compiler is included in the [Acton](/contract-dev/acton) development environment.

Originally, [Fift](/languages/fift/overview), a Forth-like assembly language, and [FunC](/languages/func/overview), a C-like intermediate-level language, were used for contract development with [Blueprint](/contract-dev/blueprint/overview).
