...
Example: [`cell_depth(cell c)`](/languages/func/stdlib#cell_depth) receives a `cell` as input, and its specification states that if the input cell is `null`, the function returns `0`.
