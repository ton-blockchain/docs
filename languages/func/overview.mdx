...
- [`store_uint`](/languages/func/stdlib#store_uint), [`store_slice`](/languages/func/stdlib#store_slice), [`store_coins`](/languages/func/stdlib#store-coins) methods store data into the builder:
