...
- Word list: A partially created list of word references, used for creating an execution token. See section for Blocks in the Control Flow page. See also Section [4.7](/languages/fift/whitepaper#4-7-creating-and-manipulating-word-lists) in the whitepaper for a list of words that create and manipulate word lists.
