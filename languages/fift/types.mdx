...
- Fift hashmap: A hashmap specific for Fift. These hashmaps are not represented as cells, contrary to TVM hashmaps. Refer to Fift hashmaps section in the Basic Values page. As a comparison with TVM hashmaps, refer to [Section 6.3](/languages/fift/whitepaper#6-3-dictionary-manipulation) in the whitepaper for a list of words that create and manipulate TVM hashmaps.
