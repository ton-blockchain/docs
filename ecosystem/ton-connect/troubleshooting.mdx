...
Use `curl` to identify the failing layer. For the manifest schema and fields, see [Manifest](/ecosystem/ton-connect/core-concepts#manifest) and the [App manifest specification](https://github.com/ton-blockchain/ton-connect/blob/main/spec/manifest.md).
