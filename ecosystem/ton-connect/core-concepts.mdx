...
Spec reference: [Session specification](https://github.com/ton-blockchain/ton-connect/blob/main/spec/session.md). See also [Disconnect a session](/ecosystem/ton-connect/how-to/disconnect).
