...
This document provides **manual** instructions for integrating [TON Connect](/ecosystem/ton-connect/overview) into wallets and other custodian services for iOS, Android, macOS, Windows, Linux, and Web platforms.

<Aside type="note">
  Prefer to use the [WalletKit](/ecosystem/walletkit/overview) instead, unless the case requires custom integration and implementation.
</Aside>
