...
This document provides **manual** instructions for integrating [TON Connect](/ecosystem/ton-connect/overview) into wallets and other custodian services in browser extensions and in-wallet browsers.
