...
### 4.1 Node installation and data download via TON Storage
...
### 4.2 Importing downloaded data into the node database and synchronization

This process can take from one to several days depending on your server performance. You can monitor the progress using the MyTonCtrl console:
