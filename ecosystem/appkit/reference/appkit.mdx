...
Returns: <code>(ctx: ProviderFactoryContext) =&gt; <a href="#tonstakersstakingprovider">TonStakersStakingProvider</a></code>.
...
Returns: <code>(ctx: ProviderFactoryContext) =&gt; <a href="#dedustswapprovider">DeDustSwapProvider</a></code>.
...
Returns: <code>(ctx: ProviderFactoryContext) =&gt; <a href="#omnistonswapprovider">OmnistonSwapProvider</a></code>.
