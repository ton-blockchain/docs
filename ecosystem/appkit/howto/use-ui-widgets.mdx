...
You need the React providers mounted and the styles imported once at the entry file. See [Installation → Set up React providers](/ecosystem/appkit/get-started/installation/react-app#set-up-react-providers).
...
>
  <img
    ...
    width="96"
    src="/ecosystem/appkit/howto/images/use-ui-widgets/send-ton-button-light.png"
  ...
  <img
    ...
    width="96"
    src="/ecosystem/appkit/howto/images/use-ui-widgets/send-ton-button-dark.png"
    alt="SendTonButton in Storybook"
  />
</div>
...
>
  <img
    className="block dark:hidden"
    width="108"
    src="/ecosystem/appkit/howto/images/use-ui-widgets/send-jetton-button-light.png"
  ...
  <img
    className="hidden dark:block"
    width="108"
    src="/ecosystem/appkit/howto/images/use-ui-widgets/send-jetton-button-dark.png"
    alt="SendJettonButton in Storybook"
  />
</div>
...
>
  <img
    className="block dark:hidden"
    width="117"
    src="/ecosystem/appkit/howto/images/use-ui-widgets/send-light.png"
  ...
  <img
    className="hidden dark:block"
    width="117"
    src="/ecosystem/appkit/howto/images/use-ui-widgets/send-dark.png"
    alt="Send in Storybook"
  />
</div>
...
>
  <img
    className="block dark:hidden"
    width="343"
    src="/ecosystem/appkit/howto/images/use-ui-widgets/swap-widget-light.png"
  ...
  <img
    className="hidden dark:block"
    width="343"
    src="/ecosystem/appkit/howto/images/use-ui-widgets/swap-widget-dark.png"
    alt="SwapWidget in Storybook"
  />
</div>
...
<img
  className="block dark:hidden"
  width="301"
  src="/ecosystem/appkit/howto/images/use-ui-widgets/staking-widget-light.png"
  alt="StakingWidget in Storybook"
/>
<img
  className="hidden dark:block"
  width="301"
  src="/ecosystem/appkit/howto/images/use-ui-widgets/staking-widget-dark.png"
  alt="StakingWidget in Storybook"
/>
</div>
...
See a [working example](https://github.com/ton-connect/kit/tree/main/apps/appkit-minter) that integrates `<SwapWidget />` and `<StakingWidget />`.
