...
You need a connected wallet and the React provider mounted. See [Connect to a wallet](/ecosystem/appkit/howto/connect-to-a-wallet).
...
const { mutate: signText } = useSignText();
