...
You need an `AppKit` instance with at least one connector and the React provider mounted. See [Connectors](/ecosystem/appkit/get-started/connectors) and [Providers](/ecosystem/appkit/get-started/providers).
