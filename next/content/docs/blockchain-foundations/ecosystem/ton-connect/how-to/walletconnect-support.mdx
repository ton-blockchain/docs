...
For everything else, prefer native TON Connect: see [Build a dApp with React](/ecosystem/ton-connect/get-started#build-a-dapp-with-react).
...
- [Send a transaction](/ecosystem/ton-connect/how-to/send-transaction) — maps to WalletConnect's `ton_sendMessage` method.
- [Sign data](/ecosystem/ton-connect/how-to/sign-data) — maps to WalletConnect's `ton_signData` method.
- [Disconnect](/ecosystem/ton-connect/how-to/disconnect).
...
- [Build a dApp with React](/ecosystem/ton-connect/get-started#build-a-dapp-with-react)
