...
This page assumes prior knowledge of the [Tolk type system](/ecosystem/tolk/types/list-of-types) and [TVM](/ecosystem/tvm/overview). It serves as a concise low-level reference.
...
- Non-empty maps, `CELL`, have [a non-trivial bit-level layout](/ecosystem/languages/tl-b/complex-and-non-trivial-examples#hashmap).
