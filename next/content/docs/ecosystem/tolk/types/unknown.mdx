...
`unknown` represents any single-slot [TVM](/ecosystem/tvm/overview) value with contents unknown at compile-time.
...
Read more about [arrays and tuples](/ecosystem/tolk/types/tuples).
