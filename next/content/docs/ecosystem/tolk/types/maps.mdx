...
- Augmented hashmaps and [Merkle proofs](/ecosystem/primitives/proofs/overview): implement interaction manually.
- Prefix dictionaries: `import @stdlib/tvm-dicts` and use [assembly functions](/ecosystem/tolk/features/asm-functions).
...
- An empty map is represented as [TVM `NULL`](/ecosystem/tolk/types/overall-tvm-stack) and is [serialized as `0`](/ecosystem/tolk/types/overall-serialization).
