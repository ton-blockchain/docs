...
On TON, NFTs follow [TEP-62](/ecosystem/standard/tokens/nft/overview) and [TEP-64](/ecosystem/standard/tokens/metadata); royalties are defined by [TEP-66](/ecosystem/standard/tokens/nft/comparison#additional%3A-royalty). To be recognized as an NFT by ecosystem products such as wallets, explorers, and indexers, a smart contract must conform to the interfaces and internal constraints defined by these specifications.
...
- [NFT standard: TEP-62](/ecosystem/standard/tokens/nft/overview)
- [NFT royalty standard extension: TEP-66](/ecosystem/standard/tokens/nft/comparison#additional%3A-royalty)
