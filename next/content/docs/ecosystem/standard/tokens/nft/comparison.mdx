---
id: standard/tokens/nft/comparison
...
<Aside
  ...
  title="Scope"
>
  This page focuses on high‑level capabilities and typical trade‑offs. For low‑level details, see [How it Works](/ecosystem/standard/tokens/nft/how-it-works).
</Aside>
...
A cNFT (compressed NFT) combines a [standard NFT](/ecosystem/standard/tokens/nft/overview) with an [airdrop‑style distribution](/ecosystem/standard/tokens/airdrop), optimized for large distributions and for shifting minting costs from the creator to end users via [Merkle‑proof](/ecosystem/primitives/serialization/merkle)‑based self‑deployment. NFT items are self‑deployed by users using Merkle proofs instead of [airdrop markers](/ecosystem/standard/tokens/airdrop#markers).
