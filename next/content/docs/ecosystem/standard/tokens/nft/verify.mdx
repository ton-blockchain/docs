...
1. Read the NFT item index from the item contract via [get\_nft\_data()](/ecosystem/standard/tokens/nft/api#get-nft-data).
1. Query the collection with [get\_nft\_address\_by\_index(index)](/ecosystem/standard/tokens/nft/api#get-nft-address-by-index).
