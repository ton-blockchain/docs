...
<Aside type="caution">Verify that item belongs to collection via [get method in collection](/ecosystem/standard/tokens/nft/api#get-nft-address-by-index), see more [here](/ecosystem/standard/tokens/nft/verify)</Aside>
...
Same as [NFT standard](/ecosystem/standard/tokens/nft/api#get-nft-data). No arguments. Outputs:
