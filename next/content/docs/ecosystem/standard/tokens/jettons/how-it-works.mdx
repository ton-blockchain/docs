...
also have an _owner (admin)_ who, by sending suitable messages to them, [mints new tokens](/ecosystem/standard/tokens/jettons/mint), closes the minting, changes metadata, or transfers the
admin rights to another contract.

Jetton master contracts also receive notifications about the [burning of tokens](/ecosystem/standard/tokens/jettons/burn).
When they receive such a notification, they must adjust the total supply accordingly.

### Jetton wallet

_Jetton wallet_ smart contracts are used to [transfer](/ecosystem/standard/tokens/jettons/transfer), receive, and [burn](/ecosystem/standard/tokens/jettons/burn) jettons. Each jetton wallet contract stores
...
- [getting wallet balance](/ecosystem/standard/tokens/jettons/wallet-data);
- [transfer jettons](/ecosystem/standard/tokens/jettons/transfer);
