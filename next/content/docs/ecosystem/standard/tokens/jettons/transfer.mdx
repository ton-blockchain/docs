...
>
  ...
  Mitigation: Always retrieve and apply the correct `decimals` value. Test on testnet first. Read [decimals parameter](/ecosystem/standard/tokens/metadata#decimals) for details.
</Aside>
