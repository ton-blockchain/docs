...
[Read more about similar examples](/ecosystem/languages/tl-b/complex-and-non-trivial-examples).
...
To parse metadata, first retrieve the NFT data from the blockchain. For details, see [retrieving NFT data](/ecosystem/standard/tokens/nft/metadata).
