...
- `allow_elector`: Boolean flag that bypasses vesting restrictions for transfers to [Elector](/ecosystem/primitives/system#elector) and [Config](/ecosystem/primitives/system#config) contracts.
