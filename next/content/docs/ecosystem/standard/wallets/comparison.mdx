...
[Unlike some other blockchains](/learn-more/from-ethereum), wallets in TON are represented as distinct smart contracts. They handle transaction signing, replay protection, and even gasless transfers. Different wallet versions implement different custom logic, suitable for various use cases.
...
There is also a separate gas and performance [comparison](/ecosystem/standard/wallets/performance).
...
- Recommended: [Wallet v5](/ecosystem/standard/wallets/v5)
- [Wallet v4](/ecosystem/standard/wallets/v4)
