...
<Aside type="tip">
  For practical usage, see [How-to guides](/ecosystem/standard/wallets/preprocessed-v2/interact).
</Aside>
...
- [How to interact with Preprocessed Wallet V2](/ecosystem/standard/wallets/preprocessed-v2/interact)
