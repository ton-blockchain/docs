...
Wallets are often the entry point of transactions in TON. See [external messages](/ecosystem/whitepapers/ton#2-4-6-external-messages%2C-or-messages-from-nowhere).
