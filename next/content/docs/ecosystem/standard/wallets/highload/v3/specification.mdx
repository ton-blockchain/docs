...
<Aside type="tip">
  For practical usage, see [How-to guides](/ecosystem/standard/wallets/highload/v3/create).
</Aside>
...
[TL-B (Type Language - Binary)](/ecosystem/languages/tl-b/overview) is a domain-specific language designed to describe data structures in TON. The schemas below define the binary layout of the contract's storage, external messages, and internal messages.
...
<Aside
  type="caution"
>
  The public key is not the wallet address. The address is [derived](/ecosystem/primitives/addresses/derive) from the contract's [`StateInit`](/ecosystem/primitives/messages/deploy).
</Aside>
...
**Recommendation:**\
Use `subwallet_id: 0x10ad` (4269) to avoid conflicts with other wallet types (standard wallets or vesting wallets) derived from the same keypair. See [How to create Highload Wallet v3](/ecosystem/standard/wallets/highload/v3/create) for details.
...
**Purpose:**\
Specifies the [send mode](/ecosystem/primitives/messages/modes) for the internal message.

**Link:** [send\_raw\_message modes](/ecosystem/languages/func/stdlib#send-raw-message)
...
1. **State-init must not be present:**\
   State-init validation is too expensive in gas and is rarely needed. For contract deployment, use the [batch transfer pattern](/ecosystem/standard/wallets/highload/v3/send-batch-transfers) with an action list
...
**How to implement:** [Send batch transfers](/ecosystem/standard/wallets/highload/v3/send-batch-transfers)
...
**Link:** [How to verify if a message is processed](/ecosystem/standard/wallets/highload/v3/verify-is-processed)
...
**Link:** [How-to guides](/ecosystem/standard/wallets/highload/v3/create)

---

## See also

- [How to create Highload Wallet v3](/ecosystem/standard/wallets/highload/v3/create)
- [How to send single transfer](/ecosystem/standard/wallets/highload/v3/send-single-transfer)
- [How to send batch transfers](/ecosystem/standard/wallets/highload/v3/send-batch-transfers)
- [How to verify if a message is processed](/ecosystem/standard/wallets/highload/v3/verify-is-processed)
