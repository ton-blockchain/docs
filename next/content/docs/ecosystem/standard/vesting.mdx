...
Example result on [Tonviewer](/infrastructure/explorers/tonviewer):
...
>
  Staking rewards are distributed according to the pool's reward scheme. See [staking rewards distribution](/ecosystem/nodes/staking/overview#nominator-validator-rewards-distribution) for details on how rewards are calculated and split between validators and nominators.
</Aside>
...
- [Standard wallets documentation](/ecosystem/standard/wallets/history)
- [Staking organization scenarios on TON](/ecosystem/nodes/staking/overview)
