---
id: foundations/whitepapers/tvm
...
- *Cell* — A *TVM cell* consists of at most 1023 bits of data, and of at most four references to other cells. All persistent data (including TVM code) in the TON Blockchain is represented as a [collection of TVM cells](/ecosystem/whitepapers/ton#2-5-14-“everything-is-a-bag-of-cells”-philosophy).
