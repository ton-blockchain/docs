...
- The gas limit values are initialized based on the results of the [credit phase](/ecosystem/primitives/phases).

## Registers initialization

<Aside type="tip">
  For more info about registers, take a look at [Registers](/ecosystem/tvm/registers)
</Aside>
...
- Split prepare
- Merge install
- [Get method (off-chain)](/ecosystem/tvm/get-method)
...
These events are not implemented yet. Possible stack layout for split/merge events is described in [TON Blockchain](/ecosystem/whitepapers/tblkch#4-4-8-processing-split-prepare-transactions) whitepaper. However, it is subject to change.
