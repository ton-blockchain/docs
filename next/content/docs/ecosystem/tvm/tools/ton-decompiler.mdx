...
[TON Decompiler](https://github.com/tact-lang/ton-opcode) is an utility for converting [BoC](/ecosystem/primitives/serialization/boc) of the contract into a [Fift](/ecosystem/languages/fift/overview)-like pseudocode.
