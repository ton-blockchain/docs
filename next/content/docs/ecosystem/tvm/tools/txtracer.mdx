...
Web interface that displays a trace from local [`@ton/sandbox`](/ecosystem/contract-dev/blueprint/testing/reference).
...
Web interface that displays a trace from its [BoC](/ecosystem/primitives/serialization/boc).
