...
- Use [MyTonCtrl nominator pools](/ecosystem/nodes/cpp/mytonctrl/pools#nominator-pool-operations-nominator-pool-mode) for standard multi-nominator operation.
