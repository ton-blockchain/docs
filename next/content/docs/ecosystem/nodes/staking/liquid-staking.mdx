...
Vesting contracts support multiple [staking options](/ecosystem/standard/vesting#staking-options).

## See also

- [Staking links on ton.org](https://ton.org/en/stake)
- [MyTonCtrl validator guide](/ecosystem/nodes/cpp/mytonctrl/validator)
- [MyTonCtrl nominator pools](/ecosystem/nodes/cpp/mytonctrl/pools)
