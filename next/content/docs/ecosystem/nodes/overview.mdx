...
- **Rely on public endpoints** when building prototypes or light integrations. Community liteservers and APIs such as [TON Center](/ecosystem/api/toncenter) or other [RPC providers](/applications/api/overview) already expose the blockchain for read access and transaction submission.
