...
**Returns:** [`StateInit`](/ecosystem/primitives/messages/deploy) for contract deployment
...
- `provider` — `ContractProvider`
- `args` — `SenderArguments` including value, body, and [send mode](/ecosystem/primitives/messages/modes)
...
- `stateInit` — optional [`StateInit`](/ecosystem/primitives/messages/deploy) for contract deployment
