...
Message sending methods allow your application to trigger contract execution by sending [internal or external messages](/ecosystem/primitives/messages/ordinary-tx). These methods handle the construction of message bodies and transaction parameters.
...
To test contracts, follow the [Smart contract testing](/ecosystem/contract-dev/blueprint/testing/overview).

## Deployment

To deploy contracts, follow the [Deployment and interaction](/ecosystem/contract-dev/blueprint/deploy#deploying-contracts) section.
