...
For example, each address in TON could be either an **internal** message or an **external**, see [general info page](/ecosystem/primitives/addresses/overview).
...
For a detailed explanation of how it works, see the [complex and non-trivial examples page](/ecosystem/languages/tl-b/complex-and-non-trivial-examples).
...
For a detailed explanation of how these combinators are deserialized, see the [complex and non-trivial examples page](/ecosystem/languages/tl-b/complex-and-non-trivial-examples).
