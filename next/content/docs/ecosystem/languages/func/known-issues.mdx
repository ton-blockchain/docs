...
For functions [`muldiv`](/ecosystem/languages/func/built-ins#muldiv), [`muldivc`](/ecosystem/languages/func/built-ins#muldivc) and [`muldivr`](/ecosystem/languages/func/built-ins#muldivr),
...
The compiler simplifies the [division `/`](/ecosystem/languages/func/operators#division%2C-%2F) and [modulo `%`](/ecosystem/languages/func/operators#modulo%2C-%25) operators when their left argument is `0`,
