...
- A [number literal](/ecosystem/languages/func/literals#number-literals)
- An [identifier](/ecosystem/languages/func/literals#identifiers)
- A [compile-time builtin](/ecosystem/languages/func/literals#compile-time-built-ins)
- An [operator](/ecosystem/languages/func/operators)
...
except in cases where [asm stack rearrangement](/ecosystem/languages/func/functions#rearranging-stack-entries) explicitly defines the order.
...
Here are further examples of variable declarations, where each line is independent from the other ones. It is possible to use the keyword `var` to let the type checker infer the type, see [hole types](/ecosystem/languages/func/types#hole-type).
...
However, global variables **cannot** be redeclared. See [Global variables](/ecosystem/languages/func/global-variables).
