...
<Aside type="note">
  The official smart contract language of TON Blockchain is [Tolk](/ecosystem/tolk/overview). FunC is now a **legacy** language, with its compiler no longer maintained.
  ...
  Learn how to [migrate from FunC to Tolk](/ecosystem/tolk/from-func/tolk-vs-func).
</Aside>
...
See [absence of boolean type](/ecosystem/languages/func/types#no-boolean-type).

When checking the flag in [if..else statements](/ecosystem/languages/func/statements#if%E2%80%A6else-statement), it is unnecessary to use
the [`==` operator](/ecosystem/languages/func/operators#equality%2C-%3D%3D), since a `0` evaluates to `false`, and any nonzero value is
...
A [repeat loop](/ecosystem/languages/func/statements#repeat-loop) helps execute an action a fixed number of times. The example below computes
...
A [while loop](/ecosystem/languages/func/statements#while-loop) is useful when the number of iterations is unknown.
The following example processes the references in the message [cell](/ecosystem/primitives/serialization/cells).
...
- [Non-modifying notation using .](/ecosystem/languages/func/expressions#non-modifying-notation)
- [`begin_cell`](/ecosystem/languages/func/stdlib#begin-cell)
- [`store_uint`](/ecosystem/languages/func/stdlib#store-uint)
- [`end_cell`](/ecosystem/languages/func/stdlib#end-cell)
- [`store_ref`](/ecosystem/languages/func/stdlib#store-ref)
- [`begin_parse`](/ecosystem/languages/func/stdlib#begin-parse)
- [`slice_refs_empty?`](/ecosystem/languages/func/stdlib#slice-refs-empty%3F)
- [`load_ref`](/ecosystem/languages/func/stdlib#load-ref)

### How to write a do until loop

Use a [`do..until` loop](/ecosystem/languages/func/statements#until-loop) when the loop must execute at least once.
...
- [Non-modifying notation using .](/ecosystem/languages/func/expressions#non-modifying-notation)
- [`"<ascii string>"` compile-time builtin](/ecosystem/languages/func/literals#string-without-suffix), where `<ascii string>` is an ASCII string
- [`slice_empty?`](/ecosystem/languages/func/stdlib#slice-empty%3F)
- [`begin_cell`](/ecosystem/languages/func/stdlib#begin-cell)
- [`end_cell`](/ecosystem/languages/func/stdlib#end-cell)
- [`store_ref`](/ecosystem/languages/func/stdlib#store-ref)
- [`begin_parse`](/ecosystem/languages/func/stdlib#begin-parse)
- [`store_slice`](/ecosystem/languages/func/stdlib#store-slice)
...
- [Non-modifying notation using .](/ecosystem/languages/func/expressions#non-modifying-notation)
- [`"<ascii string>"` compile-time builtin](/ecosystem/languages/func/literals#string-without-suffix), where `<ascii string>` is an ASCII string.
- [`slice_data_empty?`](/ecosystem/languages/func/stdlib#slice-data-empty%3F)
- [`begin_cell`](/ecosystem/languages/func/stdlib#begin-cell)
- [`end_cell`](/ecosystem/languages/func/stdlib#end-cell)
- [`store_ref`](/ecosystem/languages/func/stdlib#store-ref)
- [`begin_parse`](/ecosystem/languages/func/stdlib#begin-parse)
...
- [Non-modifying notation using .](/ecosystem/languages/func/expressions#non-modifying-notation)
- [`"<ascii string>"` compile-time builtin](/ecosystem/languages/func/literals#string-without-suffix), where `<ascii string>` is an ASCII string.
- [`"<address string>"a` compile-time builtin](/ecosystem/languages/func/literals#string-with-suffix-a), where `<address string>` is a string encoding an address.
- [`slice_hash`](/ecosystem/languages/func/stdlib#slice-hash)
- [`SDEQ` asm instruction](/ecosystem/tvm/instructions#c705-sdeq)
- `equal_slice_bits`
...
- [Non-modifying notation using .](/ecosystem/languages/func/expressions#non-modifying-notation)
- [`cell_hash`](/ecosystem/languages/func/stdlib#cell-hash)
- [`begin_cell`](/ecosystem/languages/func/stdlib#begin-cell)
- [`end_cell`](/ecosystem/languages/func/stdlib#end-cell)
- [`store_uint`](/ecosystem/languages/func/stdlib#store-uint)
- [`store_ref`](/ecosystem/languages/func/stdlib#store-ref)
...
- [Non-modifying notation using .](/ecosystem/languages/func/expressions#non-modifying-notation)
- [Builder primitives](/ecosystem/languages/func/stdlib#builder-primitives)
- [Slice primitives](/ecosystem/languages/func/stdlib#slice-primitives)
- [`preload_bits`](/ecosystem/languages/func/stdlib#preload-bits)
- [`slice_bits`](/ecosystem/languages/func/stdlib#slice-bits)

### How to build a `StateInit` cell

The code follows the TL-B for [`StateInit`](/ecosystem/primitives/messages/deploy):
...
[modifying notation with the symbol `~`](/ecosystem/languages/func/expressions#modifying-notation).

**References:**

- [Non-modifying notation using .](/ecosystem/languages/func/expressions#non-modifying-notation)
- [Modifying notation using \~](/ecosystem/languages/func/expressions#modifying-notation)
- [`"<ascii string>"` compile-time builtin](/ecosystem/languages/func/literals#string-without-suffix), where `<ascii string>` is an ASCII string.
- [`new_dict`](/ecosystem/languages/func/stdlib#new-dict)
- [`dict_set` primitives](/ecosystem/languages/func/stdlib#dict-set)
- [`dict_empty?`](/ecosystem/languages/func/stdlib#dict-empty%3F)
...
- [Modifying notation using \~](/ecosystem/languages/func/expressions#modifying-notation)
- [Slice primitives](/ecosystem/languages/func/stdlib#slice-primitives)
- [`get_data`](/ecosystem/languages/func/stdlib#get-data)
- [`set_data`](/ecosystem/languages/func/stdlib#set-data)
- [Builder primitives](/ecosystem/languages/func/stdlib#builder-primitives)
- [`new_dict`](/ecosystem/languages/func/stdlib#new-dict)
- [`slice_empty?`](/ecosystem/languages/func/stdlib#slice-empty%3F)
- [`load_dict`](/ecosystem/languages/func/stdlib#load-dict)

### How to iterate dictionaries

To iterate a dictionary from the smallest to biggest key, first call a [`dict_get_min?` primitive](/ecosystem/languages/func/stdlib#dict-get-min%3F) to obtain the smallest key in the dictionary,
and then call a [`dict_get_next?` primitive](/ecosystem/languages/func/stdlib#dict-get-next%3F) inside a loop while checking a flag for existence of further key-value pairs to process.

Similarly, to iterate a dictionary from the biggest to smallest key, first call a [`dict_get_max?` primitive](/ecosystem/languages/func/stdlib#dict-get-max%3F) to obtain the biggest key in the dictionary,
and then call a [`dict_get_prev?` primitive](/ecosystem/languages/func/stdlib#dict-get-prev%3F) inside a loop while checking a flag for existence of further key-value pairs to process.
...
- [`new_dict`](/ecosystem/languages/func/stdlib#new-dict)
- [`dict_set` primitives](/ecosystem/languages/func/stdlib#dict-set)
- [`dict_get_min?` primitives](/ecosystem/languages/func/stdlib#dict-get-min%3F)
- [`dict_get_max?` primitives](/ecosystem/languages/func/stdlib#dict-get-max%3F)
- [`dict_get_next?` primitives](/ecosystem/languages/func/stdlib#dict-get-next%3F)
- [`dict_get_prev?` primitives](/ecosystem/languages/func/stdlib#dict-get-prev%3F)

### How to delete a value from a dictionary

Use the [`dict_delete?` primitives](/ecosystem/languages/func/stdlib#dict-delete%3F) to delete keys in a dictionary.
...
- [`new_dict`](/ecosystem/languages/func/stdlib#new-dict)
- [`dict_set` primitives](/ecosystem/languages/func/stdlib#dict-set)
- [`dict_delete?` primitives](/ecosystem/languages/func/stdlib#dict-delete%3F)
- [`dict_get?` primitives](/ecosystem/languages/func/stdlib#dict-get%3F)
...
Extracting a value from an empty tuple will result in an error: ["not a tuple of valid size" - `exit code 7`](/ecosystem/tvm/exit-codes#7).
...
The `tlen` [assembler function](/ecosystem/languages/func/asm-functions) uses
the [TVM instruction `TLEN`](/ecosystem/tvm/instructions#6f88-tlen) to determine the number of elements in the tuple.
...
- [Non-modifying notation using .](/ecosystem/languages/func/expressions#non-modifying-notation)
- [Modifying notation using \~](/ecosystem/languages/func/expressions#modifying-notation)
- [Assembler functions](/ecosystem/languages/func/asm-functions)
- [`empty_tuple`](/ecosystem/languages/func/stdlib#empty-tuple)
- [`tpush`](/ecosystem/languages/func/stdlib#tpush)
- [TVM Exit codes](/ecosystem/tvm/exit-codes)
- [TVM instructions](/ecosystem/tvm/instructions)
...
The `tlen` [assembler function](/ecosystem/languages/func/asm-functions) uses the [TVM instruction `TLEN`](/ecosystem/tvm/instructions#6f88-tlen) to determine the number of elements in the tuple.

The `tpop` assembler function uses the [TVM instruction `TPOP`](/ecosystem/tvm/instructions#6f8d-tpop) to detach the last element from the tuple, and
...
- [Modifying notation using \~](/ecosystem/languages/func/expressions#modifying-notation)
- [Assembler functions](/ecosystem/languages/func/asm-functions)
- [Polymorphic functions](/ecosystem/languages/func/functions#forall-declarator)
- [`empty_tuple`](/ecosystem/languages/func/stdlib#empty-tuple)
- [`tpush`](/ecosystem/languages/func/stdlib#tpush)
- [`first`](/ecosystem/languages/func/stdlib#first)
- [`at`](/ecosystem/languages/func/built-ins#at)
- [TVM instructions](/ecosystem/tvm/instructions)
...
because it uses the [No operation `NOP`](/ecosystem/tvm/instructions#00-nop) instruction. The only purpose of `to_tuple` is to tell the type-checker
...
The `tuple_length` [assembler function](/ecosystem/languages/func/asm-functions) uses the [TVM instruction `TLEN`](/ecosystem/tvm/instructions#6f88-tlen) to determine the number of elements in the tuple.

The `tpop` assembler function uses the [TVM instruction `TPOP`](/ecosystem/tvm/instructions#6f8d-tpop) to detach the last element from the tuple, and
it returns the mutated tuple and the detached element.

The `is_tuple` assembler function uses the [TVM instruction `ISTUPLE`](/ecosystem/tvm/instructions#6f8a-istuple) to determine if the argument is a tuple or not.
...
because they use the [No operation `NOP`](/ecosystem/tvm/instructions#00-nop) instruction. The only purpose of `to_tuple` and `to_int` is to tell the type-checker
...
- [Assembler functions](/ecosystem/languages/func/asm-functions)
- [Polymorphic functions](/ecosystem/languages/func/functions#forall-declarator)
- [Global Variables](/ecosystem/languages/func/global-variables)
- [TVM instructions](/ecosystem/tvm/instructions)
...
The `is_int` function uses [Fift code](/ecosystem/languages/fift/overview). Intuitively, the Fift code implements the
...
of the [CTOS TVM instruction](/ecosystem/tvm/instructions#d0-ctos):
...
of the [SBITS TVM instruction](/ecosystem/tvm/instructions#d749-sbits):
...
[Lisp-style lists](/ecosystem/languages/func/stdlib#lisp-style-lists) are represented as nested tuples. For example, the list `1, 2, 3` is represented as the
nested tuple `[1, [2, [3, null]]]`, where the value `null` acts as a marker for the end of the list.

Use the [`cons`](/ecosystem/languages/func/stdlib#cons) function to add an element at the front of the provided list. For example,
...
The [`null?`](/ecosystem/languages/func/built-ins#null%3F) function checks if the provided argument is the `null` value, or equivalently, the empty list.
...
- [Lisp-style lists](/ecosystem/languages/func/stdlib#lisp-style-lists)
- [Non-modifying notation using .](/ecosystem/languages/func/expressions#non-modifying-notation)
- [`cons`](/ecosystem/languages/func/stdlib#cons)
- [`null`](/ecosystem/languages/func/stdlib#null)
- [`null?`](/ecosystem/languages/func/built-ins#null%3F)
...
[Lisp-style lists](/ecosystem/languages/func/stdlib#lisp-style-lists) are represented as nested tuples.

It is possible to iterate a lisp-style list by using the function [`list-next`](/ecosystem/languages/func/stdlib#list-next),
...
- [`null`](/ecosystem/languages/func/stdlib#null)
- [`null?`](/ecosystem/languages/func/built-ins#null%3F)
- [`list_next`](/ecosystem/languages/func/stdlib#list-next)
...
The stack is implemented using the same technique for [lisp-style lists](/ecosystem/languages/func/stdlib#lisp-style-lists).
...
- [`null`](/ecosystem/languages/func/stdlib#null)
- [`null?`](/ecosystem/languages/func/built-ins#null%3F)
- [`slice_refs`](/ecosystem/languages/func/stdlib#slice-refs)
- [TVM instructions](/ecosystem/tvm/instructions)
...
- [Non-modifying notation using .](/ecosystem/languages/func/expressions#non-modifying-notation)
- [Modifying notation using \~](/ecosystem/languages/func/expressions#modifying-notation)
- [`recv_internal` method](/ecosystem/languages/func/special-functions#receive-internal)
- [`get_data`](/ecosystem/languages/func/stdlib#get-data)
- [`begin_parse`](/ecosystem/languages/func/stdlib#begin-parse)
- [`slice_empty?`](/ecosystem/languages/func/stdlib#slice-empty%3F)
- [`begin_cell`](/ecosystem/languages/func/stdlib#begin-cell)
- [`end_cell`](/ecosystem/languages/func/stdlib#end-cell)
- [`store_uint`](/ecosystem/languages/func/stdlib#store-uint)
- [`load_uint`](/ecosystem/languages/func/stdlib#load-uint)
- [`set_data`](/ecosystem/languages/func/stdlib#set-data)
...
- [`set_code`](/ecosystem/languages/func/stdlib#set-code)
...
the [TL-B for messages](/ecosystem/whitepapers/tblkch#3-1-7-message-layout).
...
- [`store_uint`](/ecosystem/languages/func/stdlib#store-uint)
- [`store_slice`](/ecosystem/languages/func/stdlib#store-slice)
- [`store_coins`](/ecosystem/languages/func/stdlib#store-coins)
- [`end_cell`](/ecosystem/languages/func/stdlib#end-cell)
- [TL-B for messages](/ecosystem/whitepapers/tblkch#3-1-7-message-layout)
- Sending messages page
- [`"<address string>"a` compile-time builtin](/ecosystem/languages/func/literals#string-with-suffix-a), where `<address string>` is a string encoding an address.
- [`send_raw_message`](/ecosystem/languages/func/stdlib#send-raw-message)
...
To transfer the entire balance of a smart contract, use [send mode `128`](/ecosystem/primitives/messages/modes).
...
- [Modifying notation using \~](/ecosystem/languages/func/expressions#modifying-notation)
- [load\_uint](/ecosystem/languages/func/stdlib#load-uint)
- [`load_msg_addr`](/ecosystem/languages/func/stdlib#load-msg-addr)
- Sending messages page
- [`send_raw_message`](/ecosystem/languages/func/stdlib#send-raw-message)
...
Many features in FunC come from predefined methods in the [Standard library](/ecosystem/languages/func/stdlib).
However, there are many functionalities that the standard library does not cover, but are available as [TVM instructions](/ecosystem/tvm/instructions).
In such cases, it is possible to define functions that make use of the TVM instructions.

For example, while the function [`tpush`](/ecosystem/languages/func/stdlib#tpush), which adds an element to the end of a tuple, exists in the standard library,
...
But there is a [TVM instruction `TPOP`](/ecosystem/tvm/instructions#6f8d-tpop) that does precisely this.
So, define the function `tpop` as an [assembler function](/ecosystem/languages/func/asm-functions) that wraps the `TPOP` instruction:
...
The function is [polymorphic](/ecosystem/languages/func/types#polymorphism-with-type-variables) in the sense that the type of the returned element `X`
can be any type. The function name uses the symbol `~` to indicate that this function can be called
using [modifying notation](/ecosystem/languages/func/expressions#modifying-notation).

For example, if it is certain that tuple `t` has only integer elements, call the function using
[modifying notation](/ecosystem/languages/func/expressions#modifying-notation), like this:
...
As another example, the following function determines the length of a tuple by wrapping the [`TLEN` TVM instruction](/ecosystem/tvm/instructions#6f88-tlen):

```func
int tuple_length (tuple t) asm "TLEN";
```

Further examples taken from the [Standard library](/ecosystem/languages/func/stdlib):
...
- [Modifying notation using \~](/ecosystem/languages/func/expressions#modifying-notation)
- [Standard library](/ecosystem/languages/func/stdlib)
- [TVM instructions](/ecosystem/tvm/instructions)
- [Assembler functions](/ecosystem/languages/func/asm-functions)

### How to use modifying notation on functions

To use [modifying notation](/ecosystem/languages/func/expressions#modifying-notation) on a function, define the function so
...
Refer to the [modifying notation page](/ecosystem/languages/func/expressions#modifying-notation) for further details.
...
- [now](/ecosystem/languages/func/stdlib#now)
...
- [Random Number generator primitives](/ecosystem/languages/func/stdlib#random-number-generator-primitives)
...
**Reference:** [`muldivmod`](/ecosystem/tvm/instructions#A98C)
...
- [Operators](/ecosystem/languages/func/operators)
- [Loops](/ecosystem/languages/func/statements#loops)
...
- [`begin_parse`](/ecosystem/languages/func/stdlib#begin-parse)
- [`null`](/ecosystem/languages/func/stdlib#null)
- [`divmod`](/ecosystem/languages/func/stdlib#divmod)
- [`store_uint`](/ecosystem/languages/func/stdlib#store_uint)
- [List-style lists](/ecosystem/languages/func/stdlib#lisp-style-lists)
...
- [TVM exception codes](/ecosystem/tvm/exit-codes)
- [`throw_if`](/ecosystem/languages/func/stdlib#throw-if)
- [`throw_unless`](/ecosystem/languages/func/stdlib#throw-unless)
- [`throw`](/ecosystem/languages/func/stdlib#throw)
...
Further information on workchain IDs are found in the [docs](/ecosystem/primitives/addresses/overview#workchain-id).
...
- [`cell_hash()`](/ecosystem/languages/func/stdlib#cell-hash)
- [`store_uint`](/ecosystem/languages/func/stdlib#store-uint)
- [`store_int`](/ecosystem/languages/func/stdlib#store-int)
- [Workchain ID](/ecosystem/primitives/addresses/overview#workchain-id)
- [Internal addresses](/ecosystem/primitives/addresses/overview#internal-addresses)
...
**Reference:** [TVM instructions](/ecosystem/tvm/instructions#B603)
