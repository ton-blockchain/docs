...
- Bug in optimization of [operator `<<`](/ecosystem/languages/func/operators#shift-left%2C-%3C%3C).
...
- Added pragmas for precise control of computation order: [`allow-post-modification`](/ecosystem/languages/func/compiler-directives#%23pragma-allow-post-modification) and [`compute-asm-ltr`](/ecosystem/languages/func/compiler-directives#%23pragma-compute-asm-ltr).
...
- [`try/catch` statements](/ecosystem/languages/func/statements#try-catch-statement).
- [`throw_arg`](/ecosystem/languages/func/built-ins#throw-arg), [`throw_arg_if`](/ecosystem/languages/func/built-ins#throw-arg-if), and [`throw_arg_unless`](/ecosystem/languages/func/built-ins#throw-arg-unless) functions.
...
- Support for [multiline `asm` statements](/ecosystem/languages/func/asm-functions#multi-line-asms).
...
- [Constants](/ecosystem/languages/func/literals#constants)
- [Compile-time built-ins](/ecosystem/languages/func/literals#compile-time-built-ins)
- [Semver pragmas](/ecosystem/languages/func/compiler-directives#%23pragma-version)
- [Includes](/ecosystem/languages/func/compiler-directives#%23include)
