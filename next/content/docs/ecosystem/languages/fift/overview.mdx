...
Fift also includes a macro assembler for TVM code, which is a common intermediate target of higher-level languages such as [Tolk](/ecosystem/tolk/overview) and [FunC](/ecosystem/languages/func/overview), as well as a common textual bitcode representation of smart contracts. For more examples of the latter, see [various blockchain explorers](/infrastructure/explorers/overview) and disassembled smart contracts.
...
<Columns cols={2}>
  <Card
    ...
    href="/ecosystem/languages/fift/fift-and-tvm-assembly"
  />

  <Card
    title="Deep dive into Fift"
    href="/ecosystem/languages/fift/deep-dive"
  />

  <Card
    title="Simple multi-signature wallet"
    href="/ecosystem/languages/fift/multisig"
  />
...
<Columns cols={2}>
  <Card
    ...
    href="/ecosystem/languages/fift/whitepaper"
  >
