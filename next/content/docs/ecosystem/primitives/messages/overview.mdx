...
- `info` describes the type of the message, and fields specific to messages of this type:
  ...
  - [Incoming external](/ecosystem/primitives/messages/external-in) messages are messages from the outside world to the contract.
...
- When an incoming external message is processed, a transaction will be created only if the contract [accepts](/ecosystem/primitives/messages/external-in#accept-message) the message.
