...
See [TON DNS](/ecosystem/primitives/web3/ton-dns#dns-record-types) for all record types.
...
- [Static TON Sites](/ecosystem/primitives/web3/ton-sites): a bag containing HTML and static assets can be served as a TON Site by combining TON Storage, [TON DNS](/ecosystem/primitives/web3/ton-dns), and [TON Proxy](/ecosystem/primitives/web3/ton-proxy).
