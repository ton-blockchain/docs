...
| Type ID | Description                                               |
| ------- | --------------------------------------------------------- |
| `0x01`  | [Pruned branch](/ecosystem/primitives/serialization/pruned)        |
| `0x02`  | [Library reference](/ecosystem/primitives/serialization/library)   |
| `0x03`  | [Merkle proof](/ecosystem/primitives/serialization/merkle)         |
| `0x04`  | [Merkle update](/ecosystem/primitives/serialization/merkle-update) |
...
However, the serialization of graphs formed by cells is arranged differently; see [bag of cells](/ecosystem/primitives/serialization/boc) for details.
...
All cell manipulation instructions require transforming values of `Cell` type into either [builder](/ecosystem/tvm/builders-and-slices) or [slice](/ecosystem/tvm/builders-and-slices) types before such cells can be modified or inspected.
