...
Contracts can check their precompiled gas value using the [`GETPRECOMPILEDGAS`](/ecosystem/tvm/instructions#f839-getprecompiledgas) opcode:
...
The value is also available in the [`c7`](/ecosystem/tvm/registers#c7--environment-information-and-global-variables) register environment tuple.
...
Transaction [result](/ecosystem/primitives/phases#compute-phase):
