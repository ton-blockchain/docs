...
Setting a code is one of the actions that a smart contract can perform during the [action phase](/ecosystem/primitives/phases#action-phase). It can get into the [out action list](https://github.com/ton-blockchain/ton/blob/5c0349110bb03dd3a241689f2ab334ae1a554ffb/crypto/block/block.tlb#L411) by:

- The [`SETCODE`](/ecosystem/tvm/instructions#fb04-setcode) instruction.
