...
Change a library is one of the actions that a smart contract can perform during the [action phase](/ecosystem/primitives/phases#action-phase). It adds libraries to or removes them from the collection of libraries of this smart contract. It can be appended to an [out action list](https://github.com/ton-blockchain/ton/blob/5c0349110bb03dd3a241689f2ab334ae1a554ffb/crypto/block/block.tlb#L411) by:

- The [`SETLIBCODE`](/ecosystem/tvm/instructions#fb06-setlibcode) instruction.
- The [`CHANGELIB`](/ecosystem/tvm/instructions#fb07-changelib) instruction.
