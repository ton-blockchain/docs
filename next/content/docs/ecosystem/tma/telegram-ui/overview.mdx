---
id: ecosystem/tma/telegram-ui/overview
title: "Overview"
description: ""
keywords:
  - "iOS and Android UI components"
  - "cross-platform Telegram mini app UI"
  - "Human Interface Guidelines and Material Design"
  - "iOS Material design adaptive UI"
  - "mobile design system for TMA"
---
