...
- Data layer: [TON Center API v3](/applications/api/toncenter/v3/overview) or TonAPI v2.
...
Use the [public API endpoints overview](/applications/api/overview) for testnet endpoints, including TON Center and TonAPI streaming endpoints.

### How to get test tokens

- For the standard faucet, up to 2 TON per hour, [use Telegram Testgiver TON bot](/overview/wallets/wallet-apps/get-coins#how-to-get-coins-on-testnet).
- For larger allocations up to 5,000 TON, [use the request form](/overview/wallets/wallet-apps/get-coins#use-request-form).
...
- [API overview and public endpoints](/applications/api/overview)
