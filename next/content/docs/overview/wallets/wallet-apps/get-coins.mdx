---
id: ecosystem/wallet-apps/get-coins
...
keywords:
  ...
  - "request testnet TON for testing"
  - "get testnet coins for smart contract testing"
---
...
1. Once the captcha is complete, enter the testnet wallet address.
   ...
   <Aside
     type="caution"
   >
     Verify that the pasted address belongs to the **testnet**. Mainnet and testnet addresses are distinct. See [Internal address formats](/blockchain-basics/primitives/addresses/formats#flag-definitions) for details.
   </Aside>
...
1. To [deploy the account](/overview/wallets/wallet-apps/web#deploy-the-code) send any transaction from the wallet.
