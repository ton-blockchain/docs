---
id: ecosystem/wallet-apps/addresses-workflow
title: "Addresses workflow"
description: ""
---

To understand this article, it is necessary to periodically refer to [account status page](/blockchain-basics/primitives/status).

At the moment, TON wallets work with [addresses](/blockchain-basics/primitives/addresses/formats) as follows:

When receiving:

1. Wallets display the user's address in a [user-friendly](/blockchain-basics/primitives/addresses/formats) bounceable or non-bounceable form.
