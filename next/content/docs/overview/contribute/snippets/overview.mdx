...
<Card
  ...
  horizontal="true"
>
  Display additional information on hover without going too deep. Link to the [glossary](/overview/learn-more/glossary), a detailed explanation page, or a reference page instead.
</Card>
...
1. `<Callout>` - use the custom [`<Aside>`](/overview/contribute/snippets/aside) component.
1. `<Frame>` - use the custom [`<Image>`](/overview/contribute/snippets/image) component.
