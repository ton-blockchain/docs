...
Read more: [Randomness in TON](/blockchain-basics/contract-dev/techniques/random)
...
- [RedStone](/overview/infrastructure/oracles/redstone)
- [Pyth](/overview/infrastructure/oracles/pyth)
