...
- [Addresses](/ecosystem/primitives/addresses/overview) — unique identifiers for accounts, showing balances and activity in Tonviewer.
- [Messages](/ecosystem/primitives/messages/overview) — instructions sent between addresses. In explorers, they reveal what actions are initiated and how they lead to transactions.
- [Transactions](/ecosystem/primitives/messages/ordinary-tx) — records of executed messages. Explorers display their details linked to a specific address.
...
See [Debugging with TVM Retracer](/ecosystem/contract-dev/blueprint/debug#debugging-with-tvm-retracer) for details.
