...
[wallet.ton.org](https://wallet.ton.org) is a self-custodial wallet web app that doesn't require installation. It supports regular [wallets](/ecosystem/standard/wallets/how-it-works), [Jettons](/ecosystem/standard/tokens/jettons/overview), and [NFTs](/ecosystem/standard/tokens/nft/overview). Its source code can be found [here](https://github.com/ton-blockchain/ton-wallet).
...
<Aside
  ...
  title="Bug!"
>
  There is a bug in wallet.ton.org. Mainnet [subwallet ID](/ecosystem/standard/wallets/how-it-works#subwallet-id) is used to generate the address of testnet account.
...
1. Save 24 words of the [mnemonic](/ecosystem/standard/wallets/mnemonics).<br />{<Aside type="danger" title="Funds at risk">
...
1. The interface should indicate that testnet is used. Also address of the testnet wallet in the [user-friendly format](/ecosystem/primitives/addresses/formats#user-friendly-format) starts with `k` or `0`.<br />{<Image
...
There is a [separate article](/wallets/wallet-apps/get-coins) on this.
...
Use a [blockchain explorer](/infrastructure/explorers/overview) to inspect the account. For **Testnet**, use [Tonviewer Testnet](https://testnet.tonviewer.com/).
...
By default, wallet.ton.org creates wallets with the [Wallet v5](/ecosystem/standard/wallets/v5) code deployed on them. To check which [wallet contract version](/ecosystem/standard/wallets/comparison) is used:
