...
Opens the Send screen with a jetton transfer. [Jetton](/ecosystem/standard/tokens/jettons/overview) is a standard for TON assets, like USDT, USDC and e.t.c.
...
<Aside type="tip">
  ...
  - [`decimals`](/ecosystem/standard/tokens/metadata#decimals) the number of fractional digits
