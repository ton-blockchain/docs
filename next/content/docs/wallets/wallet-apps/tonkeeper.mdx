...
It supports regular [wallets](/ecosystem/standard/wallets/how-it-works), [Jettons](/ecosystem/standard/tokens/jettons/overview), [NFTs](/ecosystem/standard/tokens/nft/overview), and [TON Connect](/ecosystem/ton-connect). Its github repository can be found [here](https://github.com/tonkeeper).
...
1. Save 24 words of the [mnemonic](/ecosystem/standard/wallets/mnemonics).
...
1. The main interface of the app should now appear, indicating that the testnet is used. Also address of the testnet wallet in the [user-friendly format](/ecosystem/primitives/addresses/formats#user-friendly-format) starts with `k` or `0`.
...
To get free coins on testnet, follow [the guide](/wallets/wallet-apps/get-coins).
...
By default, Tonkeeper creates wallets with the [Wallet v5](/ecosystem/standard/wallets/v5) code deployed on them. To switch [wallet contract version](/ecosystem/standard/wallets/comparison) to [v4](/ecosystem/standard/wallets/v4):
