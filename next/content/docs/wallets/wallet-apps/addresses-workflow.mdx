...
At the moment, TON wallets work with [addresses](/ecosystem/primitives/addresses/formats) as follows:

When receiving:

1. Wallets display the user's address in a [user-friendly](/ecosystem/primitives/addresses/formats) bounceable or non-bounceable form.
