...
- **ADNL** libraries connect to [liteserver](/blockchain-basics/nodes/overview#interacting-with-ton-nodes).
...
| ⭐ | `ton4j`                            | ✅   |      | ✅   |          | ✅       | Java       | [Code](https://github.com/ton-blockchain/ton4j)                        |                                                                                              | [Chat](https://t.me/ton4java)      |
...
|    | `adnl`                             |      | ✅   |      |          |          | TypeScript | [Code](https://github.com/tjifyodor/adnl)                          |                                                                                              |                                    |
...
- [WDK Core](https://github.com/tetherto/wdk), JavaScript - Modular library from Tether, which supports wallet management and various swap, bridge, and lending services for many blockchains at once.
