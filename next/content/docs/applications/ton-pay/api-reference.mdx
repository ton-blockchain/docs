---
id: ecosystem/ton-pay/api-reference
title: "API reference"
...
A React hook. Connect a wallet through [TON Connect](/applications/ton-connect/overview) and send a transaction.
...
- `errorCode`: TON Pay error codes in [Check payment status](/applications/ton-pay/payment-integration/status-info).
