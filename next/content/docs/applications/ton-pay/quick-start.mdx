...
<Steps>
  ...
  >
    ...
    >
      Users can close the tab before transaction results are persisted, which breaks tracking and confirmation logic. Build messages and track transactions in the [Send payments (React)](/applications/ton-pay/payment-integration/payments-react) guide.
    </Aside>
  ...
  >
    ...
    The [Check payment status](/applications/ton-pay/payment-integration/status-info) describes the response fields and lookup methods used in this step.
  </Step>
</Steps>
...
- [Send payments (React)](/applications/ton-pay/payment-integration/payments-react)
