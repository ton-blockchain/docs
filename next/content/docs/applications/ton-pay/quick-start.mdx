---
id: ecosystem/ton-pay/quick-start
title: "Quick start"
...
Before installing and setting up the TON Pay SDK, the application must provide a TON Connect manifest, which is a JSON file that defines application metadata. Wallets use the [TON Connect manifest](/applications/ton-connect/core-concepts) to discover the application.
...
<Steps>
  ...
  >
    ...
    >
      Users can close the tab before transaction results are persisted, which breaks tracking and confirmation logic. Build messages and track transactions in the [Send payments using React](/applications/ton-pay/payment-integration/payments-react) guide.
    </Aside>
  ...
  >
    ...
    The [status lookup guide](/applications/ton-pay/payment-integration/status-info) describes the response fields and lookup methods used in this step.
  </Step>
</Steps>
...
- [Build a transfer](/applications/ton-pay/payment-integration/transfer)
- [Send payments using React](/applications/ton-pay/payment-integration/payments-react)
- [Webhooks](/applications/ton-pay/webhooks)
- [API reference](/applications/ton-pay/api-reference)
