...
<ResponseField
  ...
  required
>
  Recipient wallet address in [user-friendly format](/ecosystem/primitives/addresses/formats).
</ResponseField>
...
- Ensure the sender address from TON Connect matches the format expected by the backend. Use the [user-friendly format](/ecosystem/primitives/addresses/formats) consistently.
