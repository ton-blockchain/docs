...
<Aside
  type="caution"
>
  For Toncoin payments, the recipient amount may be reduced by [network fees](/ecosystem/primitives/fees). Use jettons or slightly overpay in TON when an exact settlement amount is
  required.
</Aside>
