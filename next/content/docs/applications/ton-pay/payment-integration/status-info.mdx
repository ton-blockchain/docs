---
id: ecosystem/ton-pay/payment-integration/status-info
title: "Check payment status and retrieve info"
sidebarTitle: "Check payment status"
description: ""
---

## Overview

After sending a payment, look up the final result and details. The SDK exposes two lookup functions.
...
<Aside
  type="caution"
>
  For Toncoin payments, the recipient amount may be reduced by [network fees](/blockchain-basics/primitives/fees). Use jettons or slightly overpay in TON when an exact settlement amount is
  required.
</Aside>
