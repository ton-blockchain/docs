...
<Steps>
  ...
  >
    Ensure all wallet addresses are valid [testnet addresses](/ecosystem/primitives/addresses/formats).
  </Step>

  <Step
    title="Obtain testnet TON"
  >
    - Use testnet wallet account: [Tonkeeper](/wallets/wallet-apps/tonkeeper) or other TON wallets.
    - [Get testnet TON](/wallets/wallet-apps/get-coins) from a faucet to test transactions.
  </Step>
...
Verify testnet transactions using testnet block [explorers](/infrastructure/explorers/overview):
