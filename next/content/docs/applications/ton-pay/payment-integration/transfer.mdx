---
id: ecosystem/ton-pay/payment-integration/transfer
...
<Steps>
  ...
  >
    Ensure all wallet addresses are valid [testnet addresses](/blockchain-basics/primitives/addresses/formats).
  </Step>

  <Step
    title="Obtain testnet TON"
  >
    - Use testnet wallet account: [Tonkeeper](/overview/wallets/wallet-apps/tonkeeper) or other TON wallets.
    - [Get testnet TON](/overview/wallets/wallet-apps/get-coins) from a faucet to test transactions.
  </Step>
...
Verify testnet transactions using testnet block [explorers](/overview/infrastructure/explorers/overview):
