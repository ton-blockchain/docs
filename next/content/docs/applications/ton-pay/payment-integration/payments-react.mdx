...
<ResponseField
  ...
  required
>
  Transaction result returned by TON Connect. It contains the signed transaction [bag of cells](/ecosystem/primitives/serialization/boc) and additional transaction details.
</ResponseField>
...
>
  1. Verify that the recipient address is [a valid TON address](/ecosystem/primitives/addresses/formats).
