...
- **Asset support**: Toncoin, [jettons](/blockchain-basics/standard/tokens/jettons/overview) (including USDT), [NFTs](/blockchain-basics/standard/tokens/nft/overview) with metadata
