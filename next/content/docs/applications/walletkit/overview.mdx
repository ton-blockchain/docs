...
First, follow this step-by-step guide: [How to integrate a wallet with TON](/ecosystem/nodes/cpp/mytonctrl/wallet).
...
- [Standard contracts](/ecosystem/standard/overview)
- [Messages & Transactions](/ecosystem/primitives/messages/overview) and other primitives.
