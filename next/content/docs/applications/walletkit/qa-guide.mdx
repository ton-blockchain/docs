---
id: ecosystem/walletkit/qa-guide
...
This document provides a complete **manual** guide for custodians integrating TON Connect: from understanding what to build to verifying your implementation works correctly.
