---
id: ecosystem/ton-connect/troubleshooting
...
For frequently asked questions about expected behaviour rather than failures, see the [FAQ](/applications/ton-connect/faq).
...
**Action.** Either fall back to a supported method, or use [`walletsRequiredFeatures`](/applications/ton-connect/how-to/filter-wallets) to hide wallets that lack the feature before the user reaches the connect modal.
...
Use `curl` to identify the failing layer. For the manifest schema and fields, see [Manifest](/applications/ton-connect/core-concepts#manifest) and the [App manifest specification](https://github.com/the-ton-tech/ton-connect/blob/feature/refine-protocol/spec/manifest.md).
...
- [FAQ](/applications/ton-connect/faq) — frequently asked questions about behaviour and design choices.
- [Universal links](/applications/ton-connect/core-concepts#universal-links) — `ret` parameter reference.
- [Connect-and-act in one tap](/applications/ton-connect/how-to/embedded-request) — reduces round-trips on mobile.
