...
- Sign gasless transactions → [Sign and relay a message (gasless)](/applications/ton-connect/how-to/sign-message-gasless)
- Connect and pay in one tap → [Connect-and-act in one tap](/applications/ton-connect/how-to/embedded-request)
...
- Enable WalletConnect → [Add WalletConnect support](/applications/ton-connect/how-to/walletconnect-support)
