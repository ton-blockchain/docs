...
| Field | Type | Description |
| --- | --- | --- |
| `manifestUrl` | `string` | URL to the [manifest](https://github.com/ton-blockchain/ton-connect/blob/main/spec/manifest.md) with the dApp metadata that is displayed in the user's wallet. If not passed, the manifest is loaded from `${window.location.origin}/tonconnect-manifest.json`. |
