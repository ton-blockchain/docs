...
| Field | Type | Description |
| --- | --- | --- |
| `manifestUrl` | `string` | *Optional*. URL to the [manifest](https://github.com/ton-blockchain/ton-connect/blob/main/spec/manifest.md) with the dApp metadata that is displayed in the user's wallet. If not passed, the manifest from `${window.location.origin}/tonconnect-manifest.json` is used. |
...
[See details](https://github.com/ton-blockchain/ton-connect/blob/main/spec/bridge.md#universal-link).
