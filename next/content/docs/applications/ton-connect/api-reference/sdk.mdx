...
| Parameter | Type | Description |
| --- | --- | --- |
| `data` | [`SignDataPayload`](/applications/ton-connect/api-reference/protocol#signdatapayload) | Payload to sign. The `type` discriminator selects the payload form (`'text'`, `'binary'`, or `'cell'`). |
...
| Field | Type | Description |
| --- | --- | --- |
| `manifestUrl` | `string` | *Optional*. URL to the [manifest](https://github.com/ton-blockchain/ton-connect/blob/main/spec/manifest.md) with the dApp metadata that the wallet displays to the user. If not passed, the SDK loads the manifest from `${window.location.origin}/tonconnect-manifest.json`. |
...
| Field | Type | Description |
| --- | --- | --- |
| `universalLink` | `string` | Base part of the wallet universal url. The link should support [Ton Connect parameters](https://github.com/ton-blockchain/ton-connect/blob/main/spec/bridge.md#universal-link). |
| `bridgeUrl` | `string` | URL of the wallet's implementation of the [HTTP bridge](https://github.com/ton-blockchain/ton-connect/blob/main/spec/bridge.md#http-bridge). |
...
| `platforms` | `('ios' \| 'android' \| 'macos' \| 'windows' \| 'linux' \| 'chrome' \| 'firefox' \| 'safari')[]` | OS and browsers where the wallet could be installed |
| `universalLink` | `string` | Base part of the wallet universal url. The link should support [Ton Connect parameters](https://github.com/ton-blockchain/ton-connect/blob/main/spec/bridge.md#universal-link). |
| `deepLink` | `string` | *Optional*. Native wallet app deepLink. The link should support [Ton Connect parameters](https://github.com/ton-blockchain/ton-connect/blob/main/spec/bridge.md#universal-link). |
| `bridgeUrl` | `string` | URL of the wallet's implementation of the [HTTP bridge](https://github.com/ton-blockchain/ton-connect/blob/main/spec/bridge.md#http-bridge). |
...
| Field | Type | Description |
| --- | --- | --- |
| `device` | [`DeviceInfo`](/applications/ton-connect/api-reference/protocol#deviceinfo) | Information about user's wallet's device. |
...
Converts raw TON address to no-bounceable user-friendly format. [See details](/blockchain-basics/primitives/addresses/overview#user-friendly-address)
...
| `testOnly` | `boolean` | *Optional*. Convert address to test-only form. [See details](/blockchain-basics/primitives/addresses/overview#user-friendly-address) Defaults to `false`. |
