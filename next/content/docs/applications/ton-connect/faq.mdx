...
Walkthrough: [Connect a wallet → Authenticate with `ton_proof`](/applications/ton-connect/how-to/connect#authenticate-with-ton_proof). Reference example: [`ton-connect/demo-dapp-backend`](https://github.com/ton-connect/demo-dapp-backend).
...
- [Troubleshooting](/applications/ton-connect/troubleshooting) — error codes and manifest fetch failures.
