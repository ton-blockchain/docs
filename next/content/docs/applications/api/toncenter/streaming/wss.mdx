---
id: ecosystem/api/toncenter/streaming/wss
title: "Streaming API: WebSocket"
sidebarTitle: "WebSocket"
description: ""
---

[WebSocket](https://en.wikipedia.org/wiki/WebSocket) transport of the [Streaming API](/applications/api/toncenter/streaming/overview) is the preferred interface for persistent and bidirectional communication with dynamic subscription patterns.
...
<ParamField
  ...
  type="string[]"
>
  Wallet or contract addresses to monitor. Accepts [valid TON address formats](/blockchain-basics/primitives/addresses/formats). May be left empty when subscribing only to a `"trace"`, otherwise required for non-trace event types.
</ParamField>
...
<ParamField
  ...
  type="string[]"
>
  Wallet or contract addresses to remove from monitoring. Accepts [valid TON address formats](/blockchain-basics/primitives/addresses/formats).
</ParamField>
