...
<ParamField
  ...
  type="string[]"
>
  Wallet or contract addresses to monitor. Accepts [valid TON address formats](/ecosystem/primitives/addresses/formats). May be left empty when subscribing only to a `"trace"`, otherwise required for non-trace event types.
</ParamField>
...
<ParamField
  ...
  type="string[]"
>
  Wallet or contract addresses to remove from monitoring. Accepts [valid TON address formats](/ecosystem/primitives/addresses/formats).
</ParamField>
