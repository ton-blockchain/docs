...
<ParamField
  ...
  type="string[]"
>
  Wallet or contract addresses to monitor. Accepts [valid TON address formats](/ecosystem/primitives/addresses/formats). Optional when subscribing only to a `"trace"`, otherwise required.
</ParamField>
