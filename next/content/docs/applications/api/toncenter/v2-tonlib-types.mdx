---
id: ecosystem/api/toncenter/v2-tonlib-types
title: "Tonlib type identifiers"
description: ""
keywords:
  - "int64 serialized as string in TON API"
  - "why are numbers strings in toncenter response"
  - "JavaScript safe integer JSON serialization"
  - "big integer string encoding API v2"
  - "tonlib int64 string handling"
---
