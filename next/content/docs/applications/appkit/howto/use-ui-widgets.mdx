...
You need the React providers mounted and the styles imported once at the entry file. See [Install AppKit → Wrap the application](/applications/appkit/get-started/installation/react-app#wrap-the-application).
