...
<Aside type="note">
An application built with AppKit can interact with your own smart contract. To create a contract, use [Acton](https://ton-blockchain.github.io/acton/docs/welcome) and explore primitives, such as [Messages & Transactions](/ecosystem/primitives/messages/overview) and others.
</Aside>
