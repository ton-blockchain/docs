...
return (
    <TokenSelector
        title="TON"
        icon="https://cdn.example.com/ton_symbol.png"
        iconFallback="T"
...
```tsx
return <Logo size={48} src="https://cdn.example.com/ton_symbol.png" alt="TON" fallback="T" />;
```
...
return (
    <LogoWithNetwork
        ...
        alt="USDT"
        fallback="U"
        networkSrc="https://cdn.example.com/ton_symbol.png"
        networkAlt="TON"
    />
);
```
