...
| `config.apiUrl`        | `string`                                            | Override the base API URL. Defaults to `https://api-v2.swaps.xyz/api` (see [Swaps API Documentation](https://docs.swaps.xyz).                                                                       |
...
| `apiUrl`        | `string` | Override the base API URL. Defaults to `https://api-v2.swaps.xyz/api` (see [Swaps API Documentation](https://docs.swaps.xyz).                                                                       |
