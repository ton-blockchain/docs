...
For task-level walkthroughs, see [Send Toncoin](/applications/appkit/howto/send-toncoin), [Send jettons](/applications/appkit/howto/send-jettons), and [Mange NFTs](/applications/appkit/howto/nfts).
