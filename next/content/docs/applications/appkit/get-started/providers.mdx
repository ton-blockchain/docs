...
- For task-level walkthroughs, see [Perform swaps](/applications/appkit/howto/swaps) and [Staking](/applications/appkit/howto/staking).
- See [Use providers](/applications/appkit/howto/providers) for the full provider model — including the streaming and API client roles not covered here.
