...
Most development is done in [Tolk](/languages/tolk/overview), a high-level programming language. Its compiler is included in the [Acton](/contract-dev/acton) development environment.
