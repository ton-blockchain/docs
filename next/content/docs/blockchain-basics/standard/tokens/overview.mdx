...
- [Fungible tokens](/blockchain-basics/standard/tokens/jettons/overview) (Jettons) - this is a web3 way to create new currency on your own
- [Non-Fungible Tokens](/blockchain-basics/standard/tokens/nft/overview) (NFTs) - like Jettons, but each token is unique and represents a distinct entity
- [Soul-bound Tokens](/blockchain-basics/standard/tokens/nft/comparison#sbt) (SBTs) - like NFTs, but not-transferable, bound to a single owner
