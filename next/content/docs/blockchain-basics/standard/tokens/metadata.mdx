...
[Read more about similar examples](/blockchain-basics/languages/tl-b/complex-and-non-trivial-examples).
...
To parse metadata, first retrieve the NFT data from the blockchain. For details, see [retrieving NFT data](/blockchain-basics/standard/tokens/nft/metadata).
...
Use the following API to parse metadata: [API Metadata](/applications/api/toncenter/v3/accounts/metadata). It handles most cases within gas limits; in rare cases, parsing may fail.
