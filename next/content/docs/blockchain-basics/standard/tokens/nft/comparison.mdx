...
<Aside
  ...
  title="Scope"
>
  This page focuses on high‑level capabilities and typical trade‑offs. For low‑level details, see [How it Works](/blockchain-basics/standard/tokens/nft/how-it-works).
</Aside>
