---
id: standard/tokens/nft/nft-2.0
title: "NFT 2.0"
description: ""
---
...
On TON, NFTs follow [TEP-62](/blockchain-basics/standard/tokens/nft/overview) and [TEP-64](/blockchain-basics/standard/tokens/metadata); royalties are defined by [TEP-66](/blockchain-basics/standard/tokens/nft/comparison#additional%3A-royalty). To be recognized as an NFT by ecosystem products such as wallets, explorers, and indexers, a smart contract must conform to the interfaces and internal constraints defined by these specifications.
...
All operations that involve commercial intent must include royalty payments, as defined by the [TEP-66 specification](/blockchain-basics/standard/tokens/nft/comparison#additional%3A-royalty). This includes all market-based NFT trading models, such as auctions and offer mechanisms, as well as NFT-related DeFi use cases like floor perpetuals and staking.
...
- [NFT standard: TEP-62](/blockchain-basics/standard/tokens/nft/overview)
- [NFT royalty standard extension: TEP-66](/blockchain-basics/standard/tokens/nft/comparison#additional%3A-royalty)
