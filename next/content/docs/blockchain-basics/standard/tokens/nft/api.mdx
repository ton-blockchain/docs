...
<Aside type="caution">Verify that item belongs to collection via [get method in collection](/blockchain-basics/standard/tokens/nft/api#get-nft-address-by-index), see more [here](/blockchain-basics/standard/tokens/nft/verify)</Aside>
...
Same as [NFT standard](/blockchain-basics/standard/tokens/nft/api#get-nft-data). No arguments. Outputs:
