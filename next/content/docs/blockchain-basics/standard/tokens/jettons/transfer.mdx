---
id: standard/tokens/jettons/transfer
...
>
  ...
  Mitigation: Always retrieve and apply the correct `decimals` value. Test on testnet first. Read [decimals parameter](/blockchain-basics/standard/tokens/metadata#decimals) for details.
</Aside>
