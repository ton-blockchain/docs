---
id: standard/tokens/jettons/find
...
Or if you are sure about the structure of Jetton wallet's initial persistent storage and know its code, you can also manually create [`StateInit`](/blockchain-basics/primitives/messages/deploy) of the Jetton wallet and thus calculate its address.
...
Finally, you can use [built-in APIs](/applications/api/toncenter/introduction).
