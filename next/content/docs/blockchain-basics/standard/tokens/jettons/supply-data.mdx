---
id: standard/tokens/jettons/supply-data
title: "How to get jetton supply data"
sidebarTitle: "Get jetton supply data"
description: "Read jetton supply state — total supply, mintable flag, admin address — from on-chain get-method data."
keywords:
  - "check jetton mintable status"
  - "is jetton mintable"
  - "jetton total supply and admin"
  - "read jetton master data"
---
...
Finally, you can get this information using the [API](/applications/api/overview).
