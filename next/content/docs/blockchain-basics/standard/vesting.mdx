...
Example result on [Tonviewer](/overview/infrastructure/explorers/tonviewer):
...
1. [Import](/blockchain-basics/nodes/cpp/mytonctrl/wallet) the private key and vesting address into MyTonCtrl and use it as a standard wallet-v3.
...
For detailed setup instructions, see [MyTonCtrl single nominator pool mode](/blockchain-basics/nodes/cpp/mytonctrl/pools#single-nominator-pool-operations-single-nominator-mode).

<Aside
  type="tip"
  title="Staking rewards"
>
  Staking rewards are distributed according to the pool's reward scheme. See [staking rewards distribution](/blockchain-basics/nodes/staking/overview#nominator-validator-rewards-distribution) for details on how rewards are calculated and split between validators and nominators.
</Aside>
...
- [Standard wallets documentation](/blockchain-basics/standard/wallets/history)
- [Staking organization scenarios on TON](/blockchain-basics/nodes/staking/overview)
