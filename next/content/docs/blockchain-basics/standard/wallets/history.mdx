...
Read more about [differences](/overview/learn-more/from-ethereum).
...
Read about this standard iteration on its dedicated page: [V4 wallet standard](/blockchain-basics/standard/wallets/v4).
...
- [V5 wallet standard](/blockchain-basics/standard/wallets/v5)
- [How to interact with V5 wallet](/blockchain-basics/standard/wallets/v5-api)
...
When working with many messages in a short period, there is a need for a special wallet called a Highload Wallet. Read [the article](/blockchain-basics/standard/wallets/highload/overview) for more information.
