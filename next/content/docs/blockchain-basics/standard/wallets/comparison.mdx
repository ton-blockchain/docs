---
id: standard/wallets/comparison
title: "Comparison"
description: ""
---

[Unlike some other blockchains](/overview/learn-more/from-ethereum), wallets in TON are represented as distinct smart contracts. They handle transaction signing, replay protection, and even gasless transfers. Different wallet versions implement different custom logic, suitable for various use cases.
...
There is also a separate gas and performance [comparison](/blockchain-basics/standard/wallets/performance).
...
- Recommended: [Wallet v5](/blockchain-basics/standard/wallets/v5)
- [Wallet v4](/blockchain-basics/standard/wallets/v4)
...
- [Highload wallet implementation](/blockchain-basics/standard/wallets/highload/overview)
