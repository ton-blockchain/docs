...
This article provides only a high-level wallet V5 contract overview. If you want to learn more about how to use its interfaces or develop extensions, check out the [wallet V5 API](/blockchain-basics/standard/wallets/v5-api) article.
...
Learn more about internal message serialization [here](/blockchain-basics/standard/wallets/v5-api).
...
Learn more about actions [here](/blockchain-basics/standard/wallets/v5-api).
