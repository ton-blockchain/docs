---
id: standard/wallets/mnemonics
title: "TON wallet mnemonics"
sidebarTitle: "Mnemonics"
description: ""
keywords: ["seed phrase", "recovery phrase", "mnemonic phrase", "secret words", "backup phrase", "24 words"]
---
...
| `Salt`     | Sequence of bits, known as a [cryptographic salt](https://en.wikipedia.org/wiki/Salt_%28cryptography%29) | `"TON default seed"`                              |
