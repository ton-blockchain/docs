...
- `allow_elector`: Boolean flag that bypasses vesting restrictions for transfers to [Elector](/blockchain-basics/primitives/system#elector) and [Config](/blockchain-basics/primitives/system#config) contracts.
