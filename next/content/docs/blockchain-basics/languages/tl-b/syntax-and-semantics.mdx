---
id: languages/tl-b/syntax-and-semantics
title: "TL-B syntax and semantics"
sidebarTitle: "Syntax and semantics"
description: ""
keywords:
  - "TL-B Type variable parameter"
  - "parameterized combinator TL-B syntax"
  - "polymorphic TL-B types"
  - "generic types in TL-B"
  - "TL-B Nat and Type parameters"
---
...
For example, each address in TON could be either an **internal** message or an **external**, see [general info page](/blockchain-basics/primitives/addresses/overview).
...
For a detailed explanation of how it works, see the [complex and non-trivial examples page](/blockchain-basics/languages/tl-b/complex-and-non-trivial-examples).
...
For a detailed explanation of how these combinators are deserialized, see the [complex and non-trivial examples page](/blockchain-basics/languages/tl-b/complex-and-non-trivial-examples).
