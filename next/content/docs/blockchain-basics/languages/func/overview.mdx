...
The compiler converts FunC programs into [Fift](/languages/fift) assembly code. The Fift assembly code is then compiled down to the [TON Virtual Machine](/blockchain-basics/tvm/overview) bitcode by the [Fift](/languages/fift) compiler.
