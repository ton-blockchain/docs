...
- A [number literal](/blockchain-basics/languages/func/literals#number-literals)
- An [identifier](/blockchain-basics/languages/func/literals#identifiers)
- A [compile-time builtin](/blockchain-basics/languages/func/literals#compile-time-built-ins)
- An [operator](/blockchain-basics/languages/func/operators)
...
except in cases where [asm stack rearrangement](/blockchain-basics/languages/func/functions#rearranging-stack-entries) explicitly defines the order.
...
Here are further examples of variable declarations, where each line is independent from the other ones. It is possible to use the keyword `var` to let the type checker infer the type, see [hole types](/blockchain-basics/languages/func/types#hole-type).
...
However, global variables **cannot** be redeclared. See [Global variables](/blockchain-basics/languages/func/global-variables).
