...
- Bug in optimization of [operator `<<`](/blockchain-basics/languages/func/operators#shift-left%2C-%3C%3C).
...
- Added pragmas for precise control of computation order: [`allow-post-modification`](/blockchain-basics/languages/func/compiler-directives#%23pragma-allow-post-modification) and [`compute-asm-ltr`](/blockchain-basics/languages/func/compiler-directives#%23pragma-compute-asm-ltr).
...
- [`try/catch` statements](/blockchain-basics/languages/func/statements#try-catch-statement).
- [`throw_arg`](/blockchain-basics/languages/func/built-ins#throw-arg), [`throw_arg_if`](/blockchain-basics/languages/func/built-ins#throw-arg-if), and [`throw_arg_unless`](/blockchain-basics/languages/func/built-ins#throw-arg-unless) functions.
...
- Support for [multiline `asm` statements](/blockchain-basics/languages/func/asm-functions#multi-line-asms).
...
- [Constants](/blockchain-basics/languages/func/literals#constants)
- [Compile-time built-ins](/blockchain-basics/languages/func/literals#compile-time-built-ins)
- [Semver pragmas](/blockchain-basics/languages/func/compiler-directives#%23pragma-version)
- [Includes](/blockchain-basics/languages/func/compiler-directives#%23include)
