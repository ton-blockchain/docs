...
>
  The official smart contract language of TON Blockchain is [Tolk](/blockchain-basics/tolk/overview), and the Tact language is being **deprecated**. This page will be removed in mid-April 2026.

  The dedicated [Tact documentation](https://docs.tact-lang.org) site remains available and will continue to be available in the future.

  Thank you for all the support. Those who built Tact stand proud, with deep gratitude to the TON community <Icon icon="heart" size={12} />
</Aside>
...
- a convenient `unboc` disassembler of a contract's code compiled into a [bag of cells](/blockchain-basics/primitives/serialization/boc) `.boc` format.
...
- BoC Disassembler (`unboc`) — Disassembler for [`.boc`](/blockchain-basics/primitives/serialization/boc) files. Ships as a standalone binary with the compiler. You can invoke it by running `npx unboc` in your Tact projects.
