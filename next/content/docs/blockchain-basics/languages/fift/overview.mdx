...
<Aside type="note">
  The official smart contract language of TON Blockchain is [Tolk](/blockchain-basics/tolk/overview). Fift is now a **legacy** language, with its compiler no longer maintained.
...
Fift also includes a macro assembler for TVM code, which is a common intermediate target of higher-level languages such as [Tolk](/blockchain-basics/tolk/overview) and [FunC](/blockchain-basics/languages/func/overview), as well as a common textual bitcode representation of smart contracts. For more examples of the latter, see [various blockchain explorers](/overview/infrastructure/explorers/overview) and disassembled smart contracts.
...
<Columns cols={2}>
  <Card
    ...
    href="/blockchain-basics/languages/fift/fift-and-tvm-assembly"
  />

  <Card
    title="Deep dive into Fift"
    href="/blockchain-basics/languages/fift/deep-dive"
  />

  <Card
    title="Simple multi-signature wallet"
    href="/blockchain-basics/languages/fift/multisig"
  />
...
<Columns cols={2}>
  <Card
    ...
    href="/blockchain-basics/languages/fift/whitepaper"
  >
...
- [Forth language](https://en.wikipedia.org/wiki/Forth_%28programming_language%29)
- [Factor language](https://en.wikipedia.org/wiki/Factor_%28programming_language%29)
