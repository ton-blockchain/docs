...
This information is **very low-level**. It could be hard for newcomers and designed for advanced people who want to understand [Fift](/blockchain-basics/languages/fift/overview). The use of Fift is not required in everyday tasks.
