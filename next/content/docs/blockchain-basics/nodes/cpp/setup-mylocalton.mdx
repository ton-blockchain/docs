---
id: ecosystem/nodes/cpp/setup-mylocalton
...
- Graduate to production setups with [Setting up a node using MyTonCtrl](/blockchain-basics/nodes/cpp/setup-mytonctrl).
- Explore node roles and responsibilities in the [node overview](/blockchain-basics/nodes/overview).
