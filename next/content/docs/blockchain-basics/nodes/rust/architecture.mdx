---
id: ecosystem/nodes/rust/architecture
...
| `logs` | `150Gi`      | Default [log](/blockchain-basics/nodes/rust/logs-config) rotation is 25 GB per file with 4 rotations. Volume size can be reduced if rolling file limits are adjusted accordingly. |
