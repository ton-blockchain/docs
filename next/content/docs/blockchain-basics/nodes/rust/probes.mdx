---
id: ecosystem/nodes/rust/probes
title: "Health probes"
description: ""
---
...
These endpoints are served by the same HTTP server as `/metrics` and require the `metrics` section in the [node config](/blockchain-basics/nodes/rust/node-config).
