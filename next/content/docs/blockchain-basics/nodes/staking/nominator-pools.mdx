---
id: ecosystem/staking/nominator-pools
...
- [getPoolBookings](/applications/api/toncenter/smc-index/get-pool-bookings-method) – get all the bookings, including debits and credits, in a specified pool.
- [getNominatorBookings](/applications/api/toncenter/smc-index/get-nominator-bookings-method) – get nominator bookings, including debits and credits, in a specified pool.
- [getNominatorEarnings](/applications/api/toncenter/smc-index/get-nominator-earnings-method) – get nominator income in a specified pool, including stake amounts on each time point.
- [getNominator](/applications/api/toncenter/smc-index/get-nominator-method) – get the nominator's balances across all pools in which the nominator participates.
- [getPool](/applications/api/toncenter/smc-index/get-pool-method) – get pool data, including all nominators.

## Validator setup

- Use [MyTonCtrl nominator pools](/blockchain-basics/nodes/cpp/mytonctrl/pools#nominator-pool-operations-nominator-pool-mode) for standard multi-nominator operation.
