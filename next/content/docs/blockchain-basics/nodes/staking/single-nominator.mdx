---
id: ecosystem/staking/single-nominator
title: "Single nominator pool contracts"
sidebarTitle: "Single nominator pools"
description: ""
keywords:
  - "separate cold wallet from validator hot wallet"
  - "isolate validator wallet from staking funds"
  - "owner offline validator online wallet split"
  - "stake without exposing funds on validator node"
  - "two-wallet validator architecture"
  - "cold-hot wallet separation for validators"
  - "validator wallet separation pattern"
---
...
Follow the [MyTonCtrl single nominator pools guide](/blockchain-basics/nodes/cpp/mytonctrl/pools#single-nominator-pool-operations-single-nominator-mode).
...
- TON Center does not provide a dedicated API for single nominator pools.
  - This is similar to the limitations described for the [nominator pools API](/applications/api/toncenter/smc-index/get-nominator-bookings-method).
