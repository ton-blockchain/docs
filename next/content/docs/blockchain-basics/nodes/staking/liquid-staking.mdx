---
id: ecosystem/staking/liquid-staking
...
Vesting contracts support multiple [staking options](/blockchain-basics/standard/vesting#staking-options).

## See also

- [Staking links on ton.org](https://ton.org/en/stake)
- [MyTonCtrl validator guide](/blockchain-basics/nodes/cpp/mytonctrl/validator)
- [MyTonCtrl nominator pools](/blockchain-basics/nodes/cpp/mytonctrl/pools)
- [Vesting contracts](/blockchain-basics/standard/vesting)
- [Catchain consensus](/blockchain-basics/whitepapers/catchain)
