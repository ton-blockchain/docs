...
Web interface that displays a trace from local [`@ton/sandbox`](/blockchain-basics/contract-dev/blueprint/testing/reference).
...
Web interface that displays a trace from its [BoC](/blockchain-basics/primitives/serialization/boc).
