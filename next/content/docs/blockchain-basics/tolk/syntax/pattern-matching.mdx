---
id: tolk/syntax/pattern-matching
...
Pattern matching on union types is used in [message handling](/blockchain-basics/tolk/features/message-handling).
...
`else` is not allowed for unions, but is permitted for a [`lazy` match](/blockchain-basics/tolk/features/lazy-loading#lazy-matching).
...
Pattern matching on [enums](/blockchain-basics/tolk/types/enums) requires exhaustive coverage of all cases:
