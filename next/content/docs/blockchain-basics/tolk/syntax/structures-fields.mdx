---
id: tolk/syntax/structures-fields
title: "Structures and fields"
description: ""
---

Tolk supports [structures](/blockchain-basics/tolk/types/structures) — similar to TypeScript classes.
...
[Methods](/blockchain-basics/tolk/syntax/functions-methods) are declared separately as extension functions:
...
[Generics](/blockchain-basics/tolk/types/generics) exist only at the type level and incur no runtime cost.
...
The syntax `struct (PREFIX) Name { ... }` specifies a [serialization prefix for the structure](/blockchain-basics/tolk/types/overall-serialization#structures). For messages, 32-bit prefixes are typically called opcodes.
