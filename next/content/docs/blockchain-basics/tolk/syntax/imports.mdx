...
description: ""
keywords:
  - "cannot import get fun from another file"
  - "import error get fun entrypoint Tolk"
  - "get fun not importable across files"
  - "Tolk entrypoint import restriction"
  - "onInternalMessage cannot be imported"
---
...
<CodeGroup>
  ...
  ```javascript title="tolk-js" icon="file-code"
  runTolkCompiler({
      // ...
      pathMappings: {
          "@common": "/some/dir",
  ...
  ```typescript title="Blueprint" icon="file-code"
