---
id: tolk/features/jetton-payload
...
To throw custom error codes instead of an error with [exit code 9](/blockchain-basics/tvm/exit-codes#9:-cell-underflow), calling `loadMaybeRef()` is discouraged.
