...
- Augmented hashmaps and [Merkle proofs](/blockchain-basics/primitives/proofs/overview): implement interaction manually.
- Prefix dictionaries: `import @stdlib/tvm-dicts` and use [assembly functions](/blockchain-basics/tolk/features/asm-functions).
...
- An empty map is represented as [TVM `NULL`](/blockchain-basics/tolk/types/overall-tvm-stack) and is [serialized as `0`](/blockchain-basics/tolk/types/overall-serialization).
