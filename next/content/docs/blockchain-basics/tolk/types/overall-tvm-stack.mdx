---
id: tolk/types/overall-tvm-stack
title: "TVM stack representation"
sidebarTitle: "TVM stack"
description: ""
---

This page assumes prior knowledge of the [Tolk type system](/blockchain-basics/tolk/types/list-of-types) and [TVM](/blockchain-basics/tvm/overview). It serves as a concise low-level reference.
...
- Non-empty maps, `CELL`, have [a non-trivial bit-level layout](/blockchain-basics/languages/tl-b/complex-and-non-trivial-examples#hashmap).
