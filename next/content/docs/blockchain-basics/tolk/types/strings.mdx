---
id: tolk/types/strings
title: "Strings"
sidebarTitle: "Strings"
description: ""
---

Tolk provides a dedicated `string` type. At the TVM level, a string is a [cell](/blockchain-basics/tolk/types/cells) that stores data in snake format: a chain of cells where each cell holds a portion of the string and a reference to the next.
...
Per the [token metadata standard](/blockchain-basics/standard/tokens/metadata), strings returned from get-methods must contain prefixes for off-chain explorers and APIs:
