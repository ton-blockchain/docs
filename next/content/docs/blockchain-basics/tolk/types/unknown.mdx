---
id: tolk/types/unknown
title: "The unknown type"
sidebarTitle: "Unknown"
description: ""
---

`unknown` represents any single-slot [TVM](/blockchain-basics/tvm/overview) value with contents unknown at compile-time.
...
Read more about [arrays and tuples](/blockchain-basics/tolk/types/tuples).
