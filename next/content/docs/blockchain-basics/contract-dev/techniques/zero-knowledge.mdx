...
<Steps>
  ...
  >
    ...
    >
      ...
      [The zk-ton-examples repository](https://github.com/zk-examples/zk-ton-examples/tree/main/circuits/cubic-gnark) contains a working example of a simple cubic circuit.
    </Aside>
  </Step>
