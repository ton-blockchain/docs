...
- `stateInit` — optional [`StateInit`](/blockchain-basics/primitives/messages/deploy) cell for deploying a contract
...
For detailed configuration options, refer to the [Blueprint Configuration](/blockchain-basics/contract-dev/blueprint/config) guide.
