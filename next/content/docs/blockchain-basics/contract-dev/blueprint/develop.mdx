...
title: "Smart contract development with Blueprint"
sidebarTitle: "Smart contract development"
description: ""
---
...
Message sending methods allow your application to trigger contract execution by sending [internal or external messages](/blockchain-basics/primitives/messages/ordinary-tx). These methods handle the construction of message bodies and transaction parameters.
...
To test contracts, follow the [Smart contract testing](/blockchain-basics/contract-dev/blueprint/testing/overview).

## Deployment

To deploy contracts, follow the [Deployment and interaction](/blockchain-basics/contract-dev/blueprint/deploy#deploying-contracts) section.
