...
**Returns:** [`StateInit`](/blockchain-basics/primitives/messages/deploy) for contract deployment
...
- `provider` — `ContractProvider`
- `args` — `SenderArguments` including value, body, and [send mode](/blockchain-basics/primitives/messages/modes)
...
- `stateInit` — optional [`StateInit`](/blockchain-basics/primitives/messages/deploy) for contract deployment
