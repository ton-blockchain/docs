...
This tutorial covers building, deploying, and interacting with a smart contract on TON from start to finish using [Blueprint](/blockchain-basics/contract-dev/blueprint/overview).
