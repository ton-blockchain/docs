---
id: foundations/serialization/pruned
...
- Next, `h * 32` bytes store [representations hashes](/blockchain-basics/primitives/serialization/cells) of roots of the pruned subtrees starting
