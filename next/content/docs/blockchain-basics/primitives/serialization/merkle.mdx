---
id: foundations/serialization/merkle
title: "Merkle proofs"
description: ""
---
...
- the 256-bit first higher hash of the referenced cell `c` or the [representation hash](/blockchain-basics/primitives/serialization/cells)
