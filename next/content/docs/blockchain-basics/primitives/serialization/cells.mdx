---
id: foundations/serialization/cells
title: "Cells"
description: ""
---
...
| Type ID | Description                                               |
| ------- | --------------------------------------------------------- |
| `0x01`  | [Pruned branch](/blockchain-basics/primitives/serialization/pruned)        |
| `0x02`  | [Library reference](/blockchain-basics/primitives/serialization/library)   |
| `0x03`  | [Merkle proof](/blockchain-basics/primitives/serialization/merkle)         |
| `0x04`  | [Merkle update](/blockchain-basics/primitives/serialization/merkle-update) |
...
However, the serialization of graphs formed by cells is arranged differently; see [bag of cells](/blockchain-basics/primitives/serialization/boc) for details.
...
All cell manipulation instructions require transforming values of `Cell` type into either [builder](/blockchain-basics/tvm/builders-and-slices) or [slice](/blockchain-basics/tvm/builders-and-slices) types before such cells can be modified or inspected.
