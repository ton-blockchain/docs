---
id: foundations/serialization/merkle-update
...
- the 256-bit higher hash of the referenced cell `c1` or the [representation hash](/blockchain-basics/primitives/serialization/cells) of `c` if its level equals zero;
