---
id: foundations/web3/ton-sites
title: "TON Sites"
description: "Web services accessible through TON Network via ADNL and RLDP"
keywords: ["decentralized website", "decentralized hosting", "website hosting", "web3 hosting", "decentralized web", "host a website"]
---
...
To assign the ADNL address to a `.ton` domain, open the domain in the TON DNS management interface, paste the ADNL address into the "Site" field, and confirm the transaction with the domain owner's wallet. For record types and resolution details, see [TON DNS](/blockchain-basics/primitives/web3/ton-dns).

## Domain name resolution

### TON DNS

A `dns_adnl_address` record in TON DNS maps a `.ton` domain name to the ADNL address of the TON Site. The proxy client resolves this record and connects to the correct ADNL address. See [TON DNS](/blockchain-basics/primitives/web3/ton-dns) for the full record type specification.
...
- [TON Proxy](/blockchain-basics/primitives/web3/ton-proxy): bridges HTTP requests from a conventional browser to the ADNL network.
- [TON DNS](/blockchain-basics/primitives/web3/ton-dns): maps `.ton` domains to ADNL addresses.
