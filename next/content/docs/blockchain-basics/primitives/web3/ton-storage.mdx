---
id: foundations/web3/ton-storage
title: "TON Storage"
...
See [TON DNS](/blockchain-basics/primitives/web3/ton-dns#dns-record-types) for all record types.
...
- [Static TON Sites](/blockchain-basics/primitives/web3/ton-sites): a bag containing HTML and static assets can be served as a TON Site by combining TON Storage, [TON DNS](/blockchain-basics/primitives/web3/ton-dns), and [TON Proxy](/blockchain-basics/primitives/web3/ton-proxy).
