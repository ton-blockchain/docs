---
id: foundations/proofs/verifying-liteserver-proofs
title: Liteserver proof verification
description: ""
---

<Aside>
  This article assumes you are familiar with [Merkle proof cells](/blockchain-basics/primitives/serialization/merkle).
</Aside>
