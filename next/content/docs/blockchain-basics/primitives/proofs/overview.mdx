---
id: foundations/proofs/overview
title: "Overview"
description: ""
---
...
<Aside>
  It is highly recommended to familiarize yourself with [Exotic cells](/blockchain-basics/primitives/serialization/merkle) first. This article primarily covers situations where you want to verify a proof in a smart contract. However, the same techniques can be used to validate proofs off-chain.
</Aside>
...
This is an example of the proof composition technique described above. It is convenient because for `getRawAccountState`, the [liteserver](/blockchain-basics/nodes/overview) returns two items:
