...
Contracts can check their precompiled gas value using the [`GETPRECOMPILEDGAS`](/blockchain-basics/tvm/instructions#f839-getprecompiledgas) opcode:
...
The value is also available in the [`c7`](/blockchain-basics/tvm/registers#c7--environment-information-and-global-variables) register environment tuple.
...
Transaction [result](/blockchain-basics/primitives/phases#compute-phase):
