...
You need to send some GRAM to the newly generated wallet. For example, 0.5 GRAM. You can send testnet coins via [`@testgiver_ton_bot`](https://t.me/testgiver_ton_bot).
...
- `$AMOUNT$` - number of coins (in GRAM).
