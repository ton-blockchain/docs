...
The guide assumes familiarity with [Fift](/languages/fift/overview), the [Lite Client](/nodes/overview#interacting-with-ton-nodes), and the structure of [TON configuration parameters](/foundations/config).
