...
- [`throw_arg`](/languages/func/built-ins#throw_arg), [`throw_arg_if`](/languages/func/built-ins#throw_arg_if), and [`throw_arg_unless`](/languages/func/built-ins#throw_arg_unless) functions.
