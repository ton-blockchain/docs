...
>
  The official smart contract language of TON Blockchain is [Tolk](/tolk/overview), and the Tact language is being **deprecated**. This page will be removed once Tolk undergoes a comprehensive security audit.
