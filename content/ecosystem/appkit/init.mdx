...
The [setup with connectors](#connectors) connects to TON wallets via services such as [Tonkeeper](/ecosystem/wallet-apps/tonkeeper). To enable advanced DeFi operations like asset swaps or staking, or to set up a [streaming API](/ecosystem/api/toncenter/streaming/overview) service, configure providers.
