...
- Wallet management: access connected GRAM wallets from registered providers.
- Asset support: work with Gram (TON), jettons (tokens, i.e., USDT), and NFTs.
- React: use hooks and ready-made UI components for common cases.
- DeFi: make on-chain Gram and jetton swaps through different providers.

## Use cases

- Web2 apps that need to use TON for authorization, payments, NFT rewards, or other common needs.
- Web3 apps that need to integrate GRAM wallets.
