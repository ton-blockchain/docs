...
1. The account details will appear. In a newly created wallet, the status is `nonexist`, indicating the wallet is not deployed.<br /><Image src="/images/wallets/wallet-ton-org/address_nonexist_light.png" darkSrc="/images/wallets/wallet-ton-org/address_nonexist_dark.png" alt="Account status: nonexist" />
