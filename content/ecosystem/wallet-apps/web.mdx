...
1. Save 24 words of the [mnemonic](/standard/wallets/mnemonics).<br />{<Callout type="danger" title="Funds at risk">
...
Use a [blockchain explorer](/ecosystem/explorers/overview) to inspect the account. For **Testnet**, use [Tonscan Testnet](https://testnet.tonscan.org/).
