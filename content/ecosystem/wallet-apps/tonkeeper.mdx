...
>
  <Image
    src="/images/wallets/tonkeeper/main-int-light.png"
    darkSrc="/images/wallets/tonkeeper/main-int-dark.png"
    width={228}
    height={342}
...
- 🔴 **Account address** is shown as a base64-encoded string. It can be shared to receive GRAM, jettons, or NFTs.
- 🟢 **Send/Receive/Scan buttons** are used to transfer GRAM or jettons to another account, receive GRAM or jettons to the wallet, and scan QR codes to confirm transactions, respectively.
...
1. Click <kbd>Create New Wallet</kbd>
   ...
   >
     <Image
       src="/images/wallets/tonkeeper/create-wallet-light.png"
       darkSrc="/images/wallets/tonkeeper/create-wallet-dark.png"
       width={228}
       height={342}
       alt="Create a wallet"
     />
...
1. Create a passcode and re-enter it. Passcode is used to encrypt the mnemonic.
   ...
   >
     <Image
       src="/images/wallets/tonkeeper/passcode-light.png"
       darkSrc="/images/wallets/tonkeeper/passcode-dark.png"
       width={228}
       height={342}
     ...
     <Image
       src="/images/wallets/tonkeeper/reenter-light.png"
       darkSrc="/images/wallets/tonkeeper/reenter-dark.png"
       width={228}
       height={342}
...
1. Click <kbd>Back up your recovery phrase</kbd> and <kbd>Back Up Manually</kbd>.
   ...
   >
     <Image
       src="/images/wallets/tonkeeper/backup-light.png"
       darkSrc="/images/wallets/tonkeeper/backup-dark.png"
       width={228}
       height={300}
       alt="Back up"
     />
     ...
     <Image
       src="/images/wallets/tonkeeper/backup-manually-light.png"
       darkSrc="/images/wallets/tonkeeper/backup-manually-dark.png"
       width={228}
       height={342}
       alt="Confirm the passcode"
     />
...
1. Save 24 words of the [mnemonic](/standard/wallets/mnemonics).
   ...
   >
     <Image
       src="/images/wallets/tonkeeper/recovery-light.png"
       darkSrc="/images/wallets/tonkeeper/recovery-dark.png"
       width={228}
       height={342}
       alt="Recovery phrase"
     />
...
1. Pass the check that the mnemonic was saved.
   ...
   >
     <Image
       src="/images/wallets/tonkeeper/backup-check-light.png"
       darkSrc="/images/wallets/tonkeeper/backup-check-dark.png"
       width={228}
       height={342}
       alt="Recovery phrase"
     />
...
1. Click <kbd>wallet</kbd> to open the <kbd>Add Wallet</kbd> pop-up.
   ...
   >
     <Image
       src="/images/wallets/tonkeeper/add-testnet-wallet-light.png"
       darkSrc="/images/wallets/tonkeeper/add-testnet-wallet-dark.png"
       width={228}
       height={342}
       alt="Add testnet"
     />
...
1. In the "Add Wallet" window, scroll down to the "For developers" section. Click the "Testnet Account" card.
   ...
   >
     <Image
       src="/images/wallets/tonkeeper/for-devs-light.png"
       darkSrc="/images/wallets/tonkeeper/for-devs-dark.png"
       width={228}
       height={342}
       alt="Testnet account"
     />
...
1. Enter the recovery phrase that was provided when the wallet was created on Mainnet, then click <kbd>Confirm</kbd>.
   ...
   >
     <Image
       src="/images/wallets/tonkeeper/recovery-test-light.png"
       darkSrc="/images/wallets/tonkeeper/recovery-test-dark.png"
       width={228}
       height={342}
...
1. The main interface of the app should now appear, indicating that the testnet is used. Also address of the testnet wallet in the [user-friendly format](/foundations/addresses/formats#user-friendly-format) starts with `k` or `0`.
   ...
   >
     <Image
       src="/images/wallets/tonkeeper/main-int-test-light.png"
       darkSrc="/images/wallets/tonkeeper/main-int-test-dark.png"
       width={228}
       height={342}
...
1. Click <kbd>Send</kbd> on the main interface, enter wallet address in "Address or name", and the "Amount" of GRAM. Click <kbd>Continue</kbd>.

   <div
     style={{ display: "flex", justifyContent: "center" }}
   >
     <Image
       src="/images/wallets/tonkeeper/send-light.png"
       darkSrc="/images/wallets/tonkeeper/send-dark.png"
       width={228}
       height={342}
       alt="Send GRAM"
     />
...
1. Verify the transaction details and swipe if correct. Otherwise, tap <kbd>`<`</kbd> in the top-left corner to edit.
   ...
   >
     <Image
       src="/images/wallets/tonkeeper/confirm-light.png"
       darkSrc="/images/wallets/tonkeeper/confirm-dark.png"
       width={228}
       height={342}
...
1. In "Settings", select <kbd>Wallet v4R2</kbd> and enter the passcode.
   ...
   >
     <Image
       src="/images/wallets/tonkeeper/v4r2-light.png"
       darkSrc="/images/wallets/tonkeeper/v4r2-dark.png"
       width={228}
       height={342}
       alt="V4R2"
     />
...
>
  <Image
    src="/images/wallets/tonkeeper/wallet-v4r2-light.png"
    darkSrc="/images/wallets/tonkeeper/wallet-v4r2-dark.png"
    width={228}
    height={342}
    alt="V4R2"
  />
