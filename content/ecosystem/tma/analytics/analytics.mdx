...
| <Icon icon="/images/tma-browsers-icons/edge_48x48.png" /> Edge | <Icon icon="/images/tma-browsers-icons/firefox_48x48.png" /> Firefox | <Icon icon="/images/tma-browsers-icons/chrome_48x48.png" /> Chrome | <Icon icon="/images/tma-browsers-icons/safari_48x48.png" /> Safari | <Icon icon="/images/tma-browsers-icons/safari_48x48.png" /> iOS |
| -------------------------------------------------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------ | --------------------------------------------------------------- |
| >= 79                                                          | >= 78                                                                | >= 73                                                              | >= 12.0                                                            | >= 12.0                                                         |
