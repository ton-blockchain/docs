...
| Legacy (v2) | [`GET /addressInformation`](/ecosystem/api/toncenter/v3/api-v2/get-address-information) | Get Address Information |
| Legacy (v2) | [`POST /estimateFee`](/ecosystem/api/toncenter/v3/api-v2/estimate-fee) | Estimate Fee |
| Legacy (v2) | [`POST /message`](/ecosystem/api/toncenter/v3/api-v2/send-message) | Send Message |
| Legacy (v2) | [`POST /runGetMethod`](/ecosystem/api/toncenter/v3/api-v2/run-get-method) | Run Get-Method |
| Legacy (v2) | [`GET /walletInformation`](/ecosystem/api/toncenter/v3/api-v2/get-wallet-information) | Get Wallet Information |
