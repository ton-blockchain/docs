...
- **`min_loan`** (mode `liquid-staking`, default `41000`) — Minimum loan size in nanograms for liquid staking borrowing.
- **`max_loan`** (mode `liquid-staking`, default `43000`) — Maximum loan size in nanograms for liquid staking borrowing.
