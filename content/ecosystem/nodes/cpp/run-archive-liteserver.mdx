...
This guide describes how to set up an archive liteserver using [MyTonCtrl](/ecosystem/nodes/cpp/mytonctrl/overview), with ZFS for storage compression and snapshots.
