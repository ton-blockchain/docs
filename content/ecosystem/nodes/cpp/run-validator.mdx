...
This guide explains how to run a validator TON node with [MyTonCtrl](/ecosystem/nodes/cpp/mytonctrl/overview) from scratch.
...
Explore validator wallet by address with a [blockchain explorer](/ecosystem/explorers/overview).
