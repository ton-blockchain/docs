...
<Callout type="note">
  ...
  Most applications and wallets should continue to rely on [TON Connect](/ecosystem/ton-connect/overview), [AppKit](/ecosystem/appkit/overview), and [WalletKit](/ecosystem/walletkit/overview).
</Callout>
