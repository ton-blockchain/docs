...
<Image
  src="/images/tonviewer/trace.svg"
  darkSrc="/images/tonviewer/trace-dark.svg"
  alt="Trace overview"
/>
...
<Image
  src="/images/tonviewer/ui-overview.png"
  darkSrc="/images/tonviewer/ui-overview-dark.png"
  alt="UI overview"
/>
...
- value — amount of GRAM or jettons transferred
...
<Image
  src="/images/tonviewer/jetton-transfer.png"
  darkSrc="/images/tonviewer/jetton-transfer-dark.png"
  alt="Jetton transfer"
/>
...
- A → B: jetton transfer message with 0.2 GRAM attached to cover execution fees.
...
The attached GRAM was insufficient to cover execution and forwarding, so the contract aborted the transfer.
...
<Image
  src="/images/tonviewer/nft-transfer.png"
  darkSrc="/images/tonviewer/nft-transfer-dark.png"
  alt="NFT transfer"
/>
...
- A → B: NFT transfer message with 0.04 GRAM attached.
- B → A: bounce returning 0.036514 GRAM.
...
<Image
  src="/images/tonviewer/dex-swap.png"
  darkSrc="/images/tonviewer/dex-swap-dark.png"
  alt="DEX swap"
/>
...
- A → B: 0.3 GRAM transferred via a jetton transfer.
...
Analyze a [token swap](https://tonviewer.com/transaction/b1dce2881224590a7c60e61594c68bd477f84fe81519b373da8fbed9c0269565) from **REDO** to **GRAM**.

<Image
  src="/images/tonviewer/dex-swap-successful.png"
  darkSrc="/images/tonviewer/dex-swap-successful-dark.png"
...
- A → B: 0.2 GRAM transferred via a jetton transfer.
