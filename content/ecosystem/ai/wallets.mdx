...
1. User deploys an agentic wallet from their regular GRAM wallet by providing the operator's public key and wallet address (owner address).
...
Connect an existing GRAM wallet to access the dashboard.
