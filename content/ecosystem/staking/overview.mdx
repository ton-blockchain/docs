...
[Staking in TON](https://ton.org/en/stake) enables earning rewards by locking Gram to support network security and validation. TON supports several staking solutions, each designed for different use cases and operational models.
...
The [liquid staking contract](/ecosystem/staking/liquid-staking) enables staking services to issue liquid staking tokens (LSTs) that represent the underlying staking position. LSTs can be used in DeFi while the underlying GRAM earns rewards.
