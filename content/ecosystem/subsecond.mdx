...
- Data layer: [TON Center API v3](/ecosystem/api/toncenter/v3/overview).
...
Use the [public API endpoints overview](/ecosystem/api/overview) for testnet endpoints, including TON Center's streaming endpoints.

### How to get test tokens

- For the standard faucet, up to 2 GRAM per hour, [use Telegram Testgiver TON bot](/ecosystem/wallet-apps/get-coins#use-testgiver-ton-bot).
- For larger allocations up to 5,000 GRAM, [use the request form](/ecosystem/wallet-apps/get-coins#use-request-form).
