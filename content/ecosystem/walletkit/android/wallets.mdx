---
title: "How to manage GRAM wallets with WalletKit on the Android platform"
...
```kotlin
val wallet = walletKit.getWallet("<GRAM_WALLET_ADDRESS>")
```
...
```kotlin
walletKit.removeWallet("<GRAM_WALLET_ADDRESS>")
```
