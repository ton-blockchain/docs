---
title: "How to manage GRAM wallets with WalletKit on the iOS platform"
...
```swift
let wallet = try walletKit.wallet(address: "<GRAM_WALLET_ADDRESS>")
```
...
```swift
try await walletKit.remove(walletAddress: "<GRAM_WALLET_ADDRESS>")
```
