...
<Callout>
  [Initialize the WalletKit](/ecosystem/walletkit/web/init), [set up at least one GRAM wallet](/ecosystem/walletkit/web/wallets) and [handle connection requests](/ecosystem/walletkit/web/connections) before using examples on this page.
</Callout>
...
<Columns cols={2}>
  <Card
    ...
    icon="gem"
    horizontal="true"
    href="/ecosystem/walletkit/web/gram"
  />
</Columns>
