...
<Callout>
  [Initialize the WalletKit](/ecosystem/walletkit/web/init) and [set up at least one GRAM wallet](/ecosystem/walletkit/web/wallets) before using examples on this page.
</Callout>
