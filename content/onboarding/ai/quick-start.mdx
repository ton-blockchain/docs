...
- Fund the wallet with Toncoin. The recommended network is __mainnet__.
...
4. In the __Initial TON deposit__ field, set the amount of Toncoin to deposit from the main wallet.
