...
- **ETH-TON Bridge** ([Config Parameter 71](/foundations/config#71-and-72-and-73))
- **BNB-TON Bridge** ([Config Parameter 72](/foundations/config#71-and-72-and-73))
- **Polygon-TON Bridge** ([Config Parameter 73](/foundations/config#71-and-72-and-73))

#### Inbound bridges (config parameters 79, 81-82)

These bridges wrap tokens from other networks into Gram:

- **ETH-TON Bridge** ([Config Parameter 79](/foundations/config#79-and-81-and-82))
- **BNB-TON Bridge** ([Config Parameter 81](/foundations/config#79-and-81-and-82))
- **Polygon-TON Bridge** ([Config Parameter 82](/foundations/config#79-and-81-and-82))
