...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>tuple</td>
      <td>tuple of integer (GRAM balance) and cell or `null` (extra currencies dictionary)</td>
    </tr>
    ...
    <tr>
      ...
      <td>tuple</td>
      <td>tuple of integer (GRAM value) and cell or `null` (extra currencies dictionary)</td>
    </tr>
    ...
    <tr>
      <td>15</td>
      <td>DUEPAYMENT</td>
      <td>current debt for storage fee in nanograms</td>
      <td>integer</td>
