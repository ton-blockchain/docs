...
<Image
  src="/images/txtracer/root.png"
  darkSrc="/images/txtracer/root.png"
...
<Image
  src="/images/txtracer/transaction-light.png"
  darkSrc="/images/txtracer/transaction-dark.png"
...
<Image
  src="/images/txtracer/playground-light.png"
  darkSrc="/images/txtracer/playground-dark.png"
...
<Image
  src="/images/txtracer/explorer-light.png"
  darkSrc="/images/txtracer/explorer-dark.png"
...
<Image
  src="/images/txtracer/spec-light.png"
  darkSrc="/images/txtracer/spec-dark.png"
  alt="Screenshot of search in TVM specification by prefix 'pl'"
/>

## 5. Sandbox

Web interface that displays a trace from local [`@ton/sandbox`](/contracts/blueprint/testing/reference).
...
<Image
  src="/images/txtracer/sandbox-light.png"
  darkSrc="/images/txtracer/sandbox-dark.png"
...
<Image
  src="/images/txtracer/emulate-light.png"
  darkSrc="/images/txtracer/emulate-dark.png"
  alt="Screenshot of a sample trace"
/>
