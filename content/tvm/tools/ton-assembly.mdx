...
Fift assembly files can be obtained by running [`acton compile --fift` ↗️](https://ton-blockchain.github.io/acton/docs/commands/compile) or [`acton built --output-fift` ↗️](https://ton-blockchain.github.io/acton/docs/commands/build) on Tolk contract sources.

<Callout type="note">
  Acton generates compatible `.fif` files from Tolk sources. Use [`acton compile --fift <OUTPUT_FILE>` ↗️](https://ton-blockchain.github.io/acton/docs/commands/compile) for a single source file. Use [`acton built --output-fift <OUTPUT_DIR>` ↗️](https://ton-blockchain.github.io/acton/docs/commands/build) for a configured project.
</Callout>
...
<CodeGroup>
  ...
  tdisasm -s "b5ee9c72410102010027000114ff008e83f4a413ed43d901002fa64ce73b5134348034c7f487f4fffd0115501b05485b1460ec17065c" -f hex -o decompiled.tasm

  # Base64-encoded BoC input and TASM file output
  tdisasm -s "te6cckEBAgEAJwABFP8AjoP0pBPtQ9kBAC+mTOc7UTQ0gDTH9If0//0BFVAbBUhbFGDsFwZc" -f base64 -o decompiled.tasm
  ```
</CodeGroup>
