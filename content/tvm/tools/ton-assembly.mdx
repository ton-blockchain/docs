...
The [`@ton/tasm` ↗️](https://www.npmjs.com/package/@ton/tasm) NPM package provides a set of utilities for converting between the [BoC][boc]-serialized TVM bitcode, [Fift assembly](/languages/fift/fift-assembler) sources, and a [Fift](/languages/fift/overview)-like pseudocode format called TON Assembly (TASM).
...
For the examples of the `trace` module, see the [full API documentation of `@ton/tasm` ↗️](https://github.com/ton-blockchain/tasm/blob/f5ce4619b168f0d3e450183816b928e50493aa69/API.md#trace-module-correlating-logs-with-source-code).
