...
For the underlying export flow, see [Zero-knowledge proofs on TON](/contracts/techniques/zero-knowledge).
...
- [Zero-knowledge proofs on TON](/contracts/techniques/zero-knowledge)
