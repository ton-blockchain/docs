...
<Callout type="tip">
  ...
  For repo-backed examples from [`zk-ton-examples`](https://github.com/zk-examples/zk-ton-examples/) covering Circom, Noname, Gnark, and Arkworks, see [Groth16 verification examples](/contracts/techniques/groth16-examples).
</Callout>
