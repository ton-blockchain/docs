...
<Image
  src="/images/claim_light.png"
  darkSrc="/images/claim_dark.png"
...
The airdrop contract stores a root hash of a dictionary (see [hashmap](/foundations/tlb/complex-and-non-trivial-examples#hashmap)) containing all allocations. Users present a [Merkle proof](/foundations/proofs/overview) to verify their allocation against this root.
...
For signature implementation details and security considerations, see [signing messages](/contracts/techniques/signing).
...
<Image
  src="/images/airdrop-light.png"
  darkSrc="/images/airdrop-dark.png"
...
- [cNFT](/contracts/standard/tokens/nft/comparison#cnft)
- [Mintless Jetton](/contracts/standard/tokens/jettons/mintless/overview)
