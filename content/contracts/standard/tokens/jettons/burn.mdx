...
To burn Jettons manually, use a web service, for example [TON Minter](https://minter.ton.org/):
...
<Image
  src="/images/burning-ton-minter.png"
  darkSrc="/images/burning-ton-minter.png"
  alt="Burning"
/>

## Another approach

An alternative way to burn tokens is to send them to a ["zero" account](https://tonscan.org/UQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAJKZ), see [How to transfer](/contracts/standard/tokens/jettons/transfer) page. A wallet app can be used for this.
