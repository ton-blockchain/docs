...
The TON blockchain supports three distinct categories of [digital tokens](https://en.wikipedia.org/wiki/Fungibility#Cryptocurrencies), each designed to serve different purposes within the ecosystem:

- [Fungible Tokens](/contracts/standard/tokens/jettons/overview) (Jettons) - this is a web3 way to create new currency on your own
- [Non-Fungible Tokens](/contracts/standard/tokens/nft/overview) (NFTs) - like Jettons, but each token is unique and represents a distinct entity
- [Soul-bound Tokens](/contracts/standard/tokens/nft/comparison#sbt) (SBTs) - like NFTs, but not-transferable, bound to a single owner
...
Token verification is managed through the public repository [`ton-assets`](https://github.com/tonkeeper/ton-assets). This repository contains approved token metadata.
