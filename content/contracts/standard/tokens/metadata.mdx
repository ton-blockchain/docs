...
[Read more about similar examples](/foundations/tlb/complex-and-non-trivial-examples).
...
To parse metadata, first retrieve the NFT data from the blockchain. For details, see [retrieving NFT data](/contracts/standard/tokens/nft/metadata).
...
On-chain NFT: [`EQBq5z4N_GeJyBdvNh4tPjMpSkA08p8vWyiAX6LNbr3aLjI0`](https://tonscan.org/EQBq5z4N_GeJyBdvNh4tPjMpSkA08p8vWyiAX6LNbr3aLjI0)

Semi-chain NFT: [`EQB2NJFK0H5OxJTgyQbej0fy5zuicZAXk2vFZEDrqbQ_n5YW`](https://tonscan.org/EQB2NJFK0H5OxJTgyQbej0fy5zuicZAXk2vFZEDrqbQ_n5YW)

On-chain jetton master: [`EQCxE6mUtQJKFnGfaROTKOt1lZbDiiX1kCixRv7Nw2Id_sDs`](https://tonscan.org/EQCxE6mUtQJKFnGfaROTKOt1lZbDiiX1kCixRv7Nw2Id_sDs)

## How to parse

Use the following API to parse metadata: [API Metadata](/api/v3/accounts/metadata?playground=open). It handles most cases within gas limits; in rare cases, parsing may fail.
