...
<Callout type="tip">
  For practical usage, see [How-to guides](/contracts/standard/wallets/preprocessed-v2/interact).
</Callout>
...
- [How to interact with Preprocessed Wallet V2](/contracts/standard/wallets/preprocessed-v2/interact)
