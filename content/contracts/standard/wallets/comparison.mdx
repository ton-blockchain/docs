...
There is also a separate gas and performance [comparison](/contracts/standard/wallets/performance).

## Use cases

### Retail users

If you are new to TON and want to create your first wallet to engage with the ecosystem, wallet **v5** is your best choice.
...
- **Daily payments**: Send and receive GRAM for everyday transactions
...
- Recommended: [Wallet v5](/contracts/standard/wallets/v5)
- [Wallet v4](/contracts/standard/wallets/v4)
