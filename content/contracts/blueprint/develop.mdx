...
To test contracts, follow the [Smart contract testing](/contracts/blueprint/testing/overview).

## Deployment

To deploy contracts, follow the [Deployment and interaction](/contracts/blueprint/deploy#deploying-contracts) section.
