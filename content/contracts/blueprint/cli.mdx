...
1. Programming language choice (Tolk or FunC)
...
- `contracts/MyContract.{tolk|fc}` — contract source code
...
For detailed information about build artifacts, see [Compiled Artifacts](/contracts/blueprint/develop#compiled-artifacts).
...
- `--dton` — use dTON explorer (deprecated)
