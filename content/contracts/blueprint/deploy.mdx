...
After deploying your contracts, you can interact with them using Blueprint scripts. These scripts use the [wrappers](/contracts/blueprint/develop#wrappers) you've created to send messages and call get methods on your deployed contracts.

To run the following scripts, refer to the [Running scripts](#running-scripts) section.
