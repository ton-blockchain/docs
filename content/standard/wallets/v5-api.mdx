...
You can send this BoC to the network in any convenient way, e.g. with API provider like [TON Center /message](https://toncenter.com/api/v3/index.html#/api%2Fv2/api_v3_post_v2_message) or with your own [liteserver](/ecosystem/nodes/overview).
