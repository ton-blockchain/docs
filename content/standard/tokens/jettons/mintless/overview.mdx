...
Because wallet applications handle claims automatically, dApps like DEXes or lending platforms don’t need special logic for mintless jettons. DApps can use APIs, such as [TON Center](/ecosystem/api/toncenter/introduction), to display unclaimed balances.
