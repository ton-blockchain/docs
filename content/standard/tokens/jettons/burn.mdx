...
An alternative way to burn tokens is to send them to a ["zero" account](https://tonscan.org/UQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAJKZ), see [How to transfer](/standard/tokens/jettons/transfer) page. A wallet app can be used for this.
...
async function main() {
    ...
    // create a client for GRAM wallet
