...
1. Read the NFT item index from the item contract via [get\_nft\_data()](/standard/tokens/nft/api#get_nft_data).
1. Query the collection with [get\_nft\_address\_by\_index(index)](/standard/tokens/nft/api#get_nft_address_by_index).
