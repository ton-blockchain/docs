...
<Callout type="caution">Verify that item belongs to collection via [get method in collection](/standard/tokens/nft/api#get_nft_address_by_index), see more [here](/standard/tokens/nft/verify)</Callout>
