...
The vesting sender requests the recipient's GRAM wallet address. If the wallet is not deployed, the sender transfers 1 GRAM to the recipient and requests they send it back. This verifies wallet access and ensures deployment.
