---
title: "Use basic getter hooks in AppKit"
...
You need the React providers in place. See [Install AppKit → Wrap the application](/applications/appkit/get-started/installation/react-app#wrap-the-application).
...
- For a full walkthrough of reading Gram, jetton, and NFT data, see [Read balances](/applications/appkit/howto/read-balances).
