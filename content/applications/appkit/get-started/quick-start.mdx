...
The generated project is a working reference implementation. From here, go directly to [How-to guides](/applications/appkit/howto/overview) — they cover every AppKit feature with practical code.
...
You can also look up types and signatures in [Reference](/applications/appkit/reference/reference).
