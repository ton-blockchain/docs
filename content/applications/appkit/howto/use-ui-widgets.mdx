...
You need the React providers mounted and the styles imported once at the entry file. If you used [Quick start](/applications/appkit/get-started/quick-start), this is already configured.
