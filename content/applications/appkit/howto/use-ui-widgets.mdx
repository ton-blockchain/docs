---
title: "How to use UI widgets in AppKit"
...
You need the React providers mounted and the styles imported once at the entry file. If you used `npm create ton-appkit` from [Quick start](/applications/appkit/get-started/quick-start), this is already configured.

<Callout type="note">
  To learn how this is set up, see [Install AppKit → Import styles](/applications/appkit/get-started/installation/react-app#import-styles).
</Callout>
...
<Image
  src="/images/appkit/send-ton-button-light.png"
  darkSrc="/images/appkit/send-ton-button-dark.png"
  alt="SendTonButton in the Storybook"
/>
...
<Image
  src="/images/appkit/send-jetton-button-light.png"
  darkSrc="/images/appkit/send-jetton-button-dark.png"
...
<Image
  src="/images/appkit/send-light.png"
  darkSrc="/images/appkit/send-dark.png"
...
<Image
  src="/images/appkit/swap-widget-light.png"
  darkSrc="/images/appkit/swap-widget-dark.png"
...
<Image
  src="/images/appkit/staking-widget-light.png"
  darkSrc="/images/appkit/staking-widget-dark.png"
...
- [Manage NFTs](/applications/appkit/howto/nfts)
