...
You need an `AppKit` instance with at least one connector and the React providers mounted. If you used [Quick start](/applications/appkit/get-started/quick-start), this is already configured.
