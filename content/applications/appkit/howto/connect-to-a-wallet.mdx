---
title: "How to connect to a wallet in AppKit"
...
You need an `AppKit` instance with at least one connector and the React providers mounted. If you used `npm create ton-appkit` from [Quick start](/applications/appkit/get-started/quick-start), this is already configured.

<Callout type="note">
  To learn how this is set up, see [Add wallet connectors](/applications/appkit/get-started/connectors) for the instance and [Install AppKit → Wrap the application](/applications/appkit/get-started/installation/react-app#wrap-the-application) for the provider setup.
</Callout>
...
- [Set up AppKit](/applications/appkit/howto/appkit)
