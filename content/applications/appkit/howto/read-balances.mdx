---
title: "How to read balances with AppKit"
...
Mount `useWatchBalance()` and `useWatchJettons()` once high in the tree to keep the cache pushed live. See [Stream live updates](/applications/appkit/howto/streaming).
