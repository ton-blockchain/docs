---
title: "How to send jettons with AppKit"
...
Before opening the wallet, make sure the sender's wallet has enough Gram to cover the [fees](/blockchain-basics/primitives/fees).
