...
<Callout type="note">
  Starting from scratch? To scaffold a working app in one command, run `npm create ton-appkit`, as shown in [Quick start](/applications/appkit/get-started/quick-start). Come back to this page to understand how the generated configuration works.
</Callout>
