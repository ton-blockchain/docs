...
<Callout type="note">
  Starting from scratch? [Quick start](/applications/appkit/get-started/quick-start) scaffolds a working app in one command. Come back to this page to understand how the generated configuration works.
</Callout>
