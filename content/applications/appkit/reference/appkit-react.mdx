---
title: "`@ton/appkit-react` reference"
...
| Parameter       | Type                                                                                           | Description                                                                            |
| --------------- | ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| `parameters`    | [`GetStakingProviderOptions`](/applications/appkit/reference/appkit#getstakingprovideroptions) | Optional provider ID.                                                                  |
...
Pre-wired button that builds a Gram transfer with [`createTransferTonTransaction`](/applications/appkit/reference/appkit#createtransfertontransaction) and dispatches it through the standard `Send` flow on click — disabled until both `recipientAddress` and `amount` are set.
