---
title: "How to build a transfer in TON Pay"
...
<ParamField
  ...
  required
>
  Human-readable payment amount. Decimals are allowed, for example, 10.5 GRAM.
</ParamField>
...
<ParamField
  ...
  required
>
  Asset to transfer. Use "GRAM" for Gram or a jetton master address or constant, for example, USDT.
</ParamField>
...
<ParamField
  ...
  type="number"
>
  Jetton only. Numeric identifier embedded into the jetton payload for idempotency and tracking. Ignored for Gram payments.
</ParamField>
...
<Steps>
  ...
  <Step>
    ...
    - Use testnet wallet account: [Tonkeeper](/ecosystem/wallet-apps/tonkeeper) or other GRAM wallets.
    - [Get testnet GRAM](/ecosystem/wallet-apps/get-coins) from a faucet to test transactions.
  </Step>
