---
title: "How to check status and retrieve info with TON Pay"
...
<Callout type="caution">
  For Gram payments, the recipient amount may be reduced by [network fees](/foundations/fees). Use jettons or slightly overpay in TON when an exact settlement amount is
  required.
</Callout>
