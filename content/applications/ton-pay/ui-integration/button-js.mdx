...
<Steps>
  ...
  <Step>
    ...
    Create a [`tonconnect-manifest.json` file](/applications/ton-connect/core-concepts#manifest) and host it on a public HTTPS URL.
          ...
          try {
            ...
            // Build the payment message
              const message = {
                ...
                amount: "1000000", // 0.001 GRAM in nanograms
...
<Steps>
  <Step>
    ...
    <body>
      <button id="pay-btn">Pay with Gram</button>
      <div id="status"></div>
    </body>
    </html>
    ```
...
<CodeGroup>
  ```html title="Default blue button"
