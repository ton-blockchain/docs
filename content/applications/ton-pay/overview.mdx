...
<Columns cols={2}>
  <Card
    ...
    icon="credit-card"
  >
    Accept TON and jettons as fiat-equivalent funds in the GRAM wallet, without intermediaries.
  </Card>
...
TON Pay SDK is compatible with GRAM wallets through the [TON Connect protocol](/ecosystem/ton-connect/overview):
