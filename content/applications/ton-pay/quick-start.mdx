---
title: "Quick start with TON Pay"
...
Before installing and setting up the TON Pay SDK, the application must provide a TON Connect manifest, which is a JSON file that defines application metadata. Wallets use the [TON Connect manifest](/applications/ton-connect/core-concepts#manifest) to discover the application.
