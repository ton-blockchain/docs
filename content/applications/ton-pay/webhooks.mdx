...
<Callout
  ...
  title="Type safety"
>
  Webhook types are exported from [`@ton-pay/api`](/applications/ton-pay/api-reference). Use `WebhookPayload` for type safety in webhook handlers.
</Callout>
  ...
  <Accordions>
    ...
    >
      ...
      <ResponseField
        ...
        required
      >
        Amount in base units; nanograms for GRAM.
      </ResponseField>
      ...
      <ResponseField
        ...
        type="string"
      >
        Human-readable asset ticker. For example, GRAM or USDT.
      </ResponseField>
