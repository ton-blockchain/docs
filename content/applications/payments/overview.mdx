UQBy0n_-pS9vDu4D3ZN9Hs7Nry662f2RpVg0i4kKlyeqSUuf---
...
[**Jettons**](/contracts/standard/tokens/jettons/overview) are fungible tokens following the TON Enhancement Proposal 74 (TEP-74) standard. Each Jetton type has a master contract and individual wallet contracts for each holder. When processing Jetton payments, you monitor the Jetton wallet contract associated with your deposit address. Transfer notifications include sender information and transfer amounts.

Read more about [how Jettons work](/contracts/standard/tokens/jettons/how-it-works).

- [Gram processing](/applications/payments/gram)
- [Jetton processing](/applications/payments/jettons)
