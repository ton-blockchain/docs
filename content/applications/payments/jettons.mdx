...
For architectural patterns and deposit methods comparison, see [Gram processing](/applications/payments/gram).
...
1. Parse the message body:
   ...
   - Extract `query_id`, `amount`, `sender`, and `forward_payload` [according to TL-B](/contracts/standard/tokens/jettons/api)
