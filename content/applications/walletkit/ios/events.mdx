---
title: "How to connect to dApp and handle wallet events with WalletKit on the iOS platform"
...
// To approve
try await request.approve(walletAddress: /* GRAM wallet address */)

// To reject
try await request.reject(reason: /* rejection reason */)
```

After approval, the connection will be established, and the wallet service will be able to receive and handle other events associated with the corresponding GRAM wallet.
