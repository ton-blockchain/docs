...
- **TON Connect**: Built-in support for [TON Connect](/applications/ton-connect/overview) — a standard GRAM wallet connection protocol
- **Wallet management**: Support for multiple GRAM wallets at once, with persistent storage and optional use of custom signers
- **Asset support**: Gram, [jettons](/blockchain-basics/standard/tokens/jettons/overview) (including USDT), [NFTs](/blockchain-basics/standard/tokens/nft/overview) with metadata
