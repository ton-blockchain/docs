...
<Callout>
  The API client in use is determined by the required [`networks` configuration parameter](/applications/walletkit/configure#networks-required) during [WalletKit initialization](/applications/walletkit/web/init#initialization).
</Callout>
