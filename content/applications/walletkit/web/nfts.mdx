...
To obtain a list of NFTs owned by a user, query their GRAM wallet by either the `getNfts()` method of wallet adapters or by calling `kit.nfts.getAddressNfts()` and passing it the GRAM wallet address.
...
- [NFT overview](/blockchain-basics/standard/tokens/nft/overview)
- [NFT metadata](/blockchain-basics/standard/tokens/nft/metadata)
