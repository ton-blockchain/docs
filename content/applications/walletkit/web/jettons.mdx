...
<Callout>
  [Initialize WalletKit](/applications/walletkit/web/init), [set up at least one TON wallet](/applications/walletkit/web/nit-wallet), handle [connection requests](/applications/walletkit/web/connections) and [transaction requests](/applications/walletkit/web/events) before using examples on this page.
</Callout>
