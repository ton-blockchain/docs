---
title: Integrate TON Connect into native and web wallets
sidebarTitle: Native and web wallets
noindex: true
---

This document provides **manual** instructions for integrating [TON Connect](/applications/ton-connect/overview) into wallets and other custodian services for iOS, Android, macOS, Windows, Linux, and Web platforms.

<Callout type="note">
  Prefer to use the [WalletKit](/applications/walletkit/overview) instead, unless the case requires custom integration and implementation.
</Callout>
...
<Columns cols={2}>
  ...
  <Card
    ...
    arrow="true"
    href="/applications/ton-connect/core-concepts#manifest"
  >
...
To read more about the bridge protocol, please refer to the [TON Connect Bridge documentation](https://github.com/ton-blockchain/ton-connect/blob/main/spec/bridge.md).
...
Refer to the [SessionCrypto implementation](https://github.com/ton-connect/sdk/blob/main/packages/protocol/src/crypto/session-crypto.ts) and [Session documentation](https://github.com/ton-blockchain/ton-connect/blob/main/spec/session.md) for more details.
...
Refer to the [bridge API documentation](https://github.com/ton-blockchain/ton-connect/blob/main/spec/bridge.md) for more details.
...
Refer to [Universal link](https://github.com/ton-blockchain/ton-connect/blob/main/spec/deeplinks.md#universal-link) and [`ConnectRequest`](https://github.com/ton-blockchain/ton-connect/blob/main/spec/connect.md#connectrequest) documentation for more details.
...
Refer to the [SendTransactionRequest](https://github.com/ton-blockchain/ton-connect/blob/main/spec/rpc.md#sendtransaction) documentation for more details.
...
Refer to the [DisconnectEvent](https://github.com/ton-blockchain/ton-connect/blob/main/spec/rpc.md#wallet-events) documentation for more details.
...
1. [TON Proof specification](https://github.com/ton-blockchain/ton-connect/blob/main/spec/connect.md#address-proof-signature-ton_proof)
...
- [Wallet V5](https://github.com/ton-blockchain/wallet-contract-v5)
...
- TON Connect specification:
  - [Bridge API](https://github.com/ton-blockchain/ton-connect/blob/main/spec/bridge.md)
  - [Requests and Responses](https://github.com/ton-blockchain/ton-connect/blob/main/spec/rpc.md)
  - [Session](https://github.com/ton-blockchain/ton-connect/blob/main/spec/session.md)
  - [TON Wallet Guidelines](https://github.com/ton-blockchain/ton-connect/blob/main/guides/wallet-guidelines.md)
  - [Workflows](https://github.com/ton-blockchain/ton-connect/blob/main/spec/overview.md#workflows)
- Reference implementations:
