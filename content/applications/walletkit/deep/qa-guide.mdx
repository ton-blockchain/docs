---
title: "Integrate TON Connect, test, and apply for listing"
sidebarTitle: "Integration and QA flow"
noindex: true
---

This document provides a complete **manual** guide for custodians integrating [TON Connect](/applications/ton-connect/overview): from understanding what to build to verifying your implementation works correctly.

WalletKit users can also address this guide to understand the **QA flow**.

<Callout type="note">
  Prefer to use the [WalletKit](/applications/walletkit/overview), unless the case requires custom integration and implementation.
</Callout>
