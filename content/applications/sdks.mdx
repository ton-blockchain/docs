...
<Callout type="note">
  For available APIs, see the [API overview](/api/overview). When building dApps and wallet services, use [WalletKit](/applications/walletkit/overview).
</Callout>
...
- **ADNL** libraries connect to [liteserver](/nodes/overview#interacting-with-ton-nodes).
