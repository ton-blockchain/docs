...
- [Connect a wallet and authenticate the user with `ton_proof`](/applications/ton-connect/how-to/connect)
- [Send a structured transaction](/applications/ton-connect/how-to/send-transaction)
- [Sign data](/applications/ton-connect/how-to/sign-data)
- [Sign and relay a gasless message](/applications/ton-connect/how-to/sign-message-gasless)
- [Connect-and-act in one tap](/applications/ton-connect/how-to/embedded-request)
- [Handle wallet-initiated disconnects](/applications/ton-connect/how-to/disconnect)
- [Filter wallets by required features](/applications/ton-connect/how-to/filter-wallets)
- [Enable WalletConnect support](/applications/ton-connect/how-to/walletconnect-support)
