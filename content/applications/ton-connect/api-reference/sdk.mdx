...
> Generated from `@tonconnect/sdk` v4.0.0.
...
| `deepLink`      | `string`                                                                                         | _Optional_. Optional custom-scheme deep link (e.g. `mytonwallet-tc://`). Same protocol parameters as the universal link.             |
