---
title: "API v2 TonLib type identifiers"
sidebarTitle: "TonLib types"
---
...
For background on the TL-B format used across the TON ecosystem, see the [TL-B overview](/foundations/tlb/overview).
