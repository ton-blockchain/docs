...
Increase limits by [requesting an API key](/api/get-api-key) and selecting a higher subscription plan. Without any API key, the default rate limit is 1 request per second.
