...
| --------------------------------------------------------------------------------------------------------------------- | :-----------: | :-------: | :------: |
| [`transactions`](/api/v3/blockchain-data/get-transactions)                                        |       10      |    1000   |    Yes   |
| [`actions`](/api/v3/actions-and-traces/get-actions)                                               |       10      |    1000   |    Yes   |
| [`blocks`](/api/v3/blockchain-data/get-blocks)                                                    |       10      |    1000   |    Yes   |
| [`messages`](/api/v3/blockchain-data/get-messages)                                                |       10      |    1000   |    Yes   |
| [`traces`](/api/v3/actions-and-traces/get-traces)                                                 |       10      |    1000   |    Yes   |
| [`jetton/burns`](/api/v3/jettons/get-jetton-burns)                                                |       10      |    1000   |    Yes   |
| [`jetton/transfers`](/api/v3/jettons/get-jetton-transfers)                                        |       10      |    1000   |    Yes   |
| [`jetton/wallets`](/api/v3/jettons/get-jetton-wallets)                                            |       10      |    1000   |    Yes   |
| [`nft/items`](/api/v3/nfts/get-nft-items)                                                         |       10      |    1000   |    Yes   |
| [`nft/transfers`](/api/v3/nfts/get-nft-transfers)                                                 |       10      |    1000   |    Yes   |
| [`multisig/orders`](/api/v3/multisig/get-multisig-orders)                                         |       10      |    1000   |    Yes   |
| [`multisig/wallets`](/api/v3/multisig/get-multisig-wallets)                                       |       10      |    1000   |    Yes   |
| [`transactionsByMasterchainBlock`](/api/v3/blockchain-data/get-transactions-by-masterchain-block) |       10      |    1000   |    Yes   |
| [`jetton/masters`](/api/v3/jettons/get-jetton-masters)                                            |       10      |    1000   |    No    |
| [`nft/collections`](/api/v3/nfts/get-nft-collections)                                             |       10      |    1000   |    No    |
| [`dns/records`](/api/v3/dns/get-dns-records)                                                      |      100      |    1000   |    No    |
| [`masterchainBlockShards`](/api/v3/blockchain-data/get-masterchain-block-shards)                  |       10      |    1000   |    No    |
| [`topAccountsByBalance`](/api/v3/stats/get-top-accounts-by-balance)                               |       10      |    1024   |    No    |
| [`transactionsByMessage`](/api/v3/blockchain-data/get-transactions-by-message)                    |       10      |    1000   |    No    |
| [`vesting`](/api/v3/vesting/get-vesting-contracts)                                                |       10      |    1000   |    No    |
