...
| :------------------------------------------: | :---------: | :---------: | :----: | :--------------------------: | :----------------------: |
|     [Tonstakers](https://tonstakers.com)     |    1 GRAM   | Yes (tsTON) |   Yes  | Up to 18h (instant possible) |            Yes           |
|         [Bemo](https://bemo.finance)         |    1 GRAM   | Yes (bmTON) |   No   |        36-72h cooldown       |            No            |
|         [Hipo](https://hipo.finance)         |    Varies   |  Yes (hTON) |   No   |  Avg 30h (instant possible)  |            No            |
| [TON Nominators](https://tonvalidators.org/) | 10,000 GRAM |      No     |   Yes  |           Up to 18h          |            No            |
...
- [Tonstakers setup](/nodes/cpp/mytonctrl/liquid-staking)
