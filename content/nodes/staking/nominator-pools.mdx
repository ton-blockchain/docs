...
- [getPoolBookings](/api/smc-index/get-pool-bookings-method) – get all the bookings, including debits and credits, in a specified pool.
- [getNominatorBookings](/api/smc-index/get-nominator-bookings-method) – get nominator bookings, including debits and credits, in a specified pool.
- [getNominatorEarnings](/api/smc-index/get-nominator-earnings-method) – get nominator income in a specified pool, including stake amounts on each time point.
- [getNominator](/api/smc-index/get-nominator-method) – get the nominator's balances across all pools in which the nominator participates.
- [getPool](/api/smc-index/get-pool-method) – get pool data, including all nominators.
