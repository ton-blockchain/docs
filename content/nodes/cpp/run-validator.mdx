...
validator_wallet_001  empty   0        v1   -1   Uf_...-Qt
```
...
Any user can deposit to the pool via a standard direct GRAM transfer. Credit a decent sum of around 10 GRAM:

```mytonctrl noCopy title="Pools list"
MyTonCtrl> pools_list
[debug] 18.11.2025, 10:57:34.006 (UTC) <MainThread> start GetPools function
[debug] 18.11.2025, 10:57:34.006 (UTC) <MainThread> start GetPoolsNameList function
[debug] 18.11.2025, 10:57:34.006 (UTC) <MainThread> start GetLocalPool function
[debug] 18.11.2025, 10:57:34.008 (UTC) <MainThread> start GetValidatorStatus function
[debug] 18.11.2025, 10:57:34.030 (UTC) <MainThread> start GetVersionFromCodeHash function
Name              Status  Balance       Version   Address
validator-1-pool  active  10.987599552  spool_r2  Ef_...K80
```
...
- For retained host metrics and incident analysis, [monitor historical host performance](/nodes/cpp/monitoring-host-performance).
