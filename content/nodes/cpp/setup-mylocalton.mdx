...
<Callout type="caution">On Windows, install [OpenSSL v1.1.1](https://slproweb.com/products/Win32OpenSSL.html) first</Callout>
...
- Graduate to production setups with [Setting up a node using MyTonCtrl](/nodes/cpp/setup-mytonctrl).
- Explore node roles and responsibilities in the [node overview](/nodes/overview).
