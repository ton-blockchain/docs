...
- `low_wallet_balance`: Validator wallet balance below 10 GRAM while the node is working and in sync.
- `low_wallet_balance_ok`: Balance recovered to ≥10 GRAM after a low-balance alert.
