...
This guide describes how to set up an archive liteserver using [MyTonCtrl](/nodes/cpp/mytonctrl/overview), with ZFS for storage compression and snapshots.
...
Set up alerting in MyTonCtrl to get a notification of critical issues with the archive liteserver. For more information, see [MyTonCtrl private alerting bot](/nodes/cpp/mytonctrl/alerting).
...
- [Run a liteserver node with MyTonCtrl](/nodes/cpp/run-liteserver)
