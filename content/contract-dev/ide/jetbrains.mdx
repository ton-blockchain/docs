...
<Image
  src="/images/intellij-ton/install-from-settings.png"
  darkSrc="/images/intellij-ton/install-from-settings-dark.png"
...
<Image
  src="/images/intellij-ton/tolk.png"
  darkSrc="/images/intellij-ton/tolk-dark.png"
...
<Image
  src="/images/intellij-ton/func.png"
  darkSrc="/images/intellij-ton/func-dark.png"
...
<Image
  src="/images/intellij-ton/fift.png"
  darkSrc="/images/intellij-ton/fift-dark.png"
  alt="Screenshot of the Fift language support"
/>

<Image
  src="/images/intellij-ton/fift-asm.png"
  darkSrc="/images/intellij-ton/fift-asm-dark.png"
...
<Image
  src="/images/intellij-ton/tlb.png"
  darkSrc="/images/intellij-ton/tlb-dark.png"
...
<Image
  src="/images/intellij-ton/tasm.png"
  darkSrc="/images/intellij-ton/tasm-dark.png"
...
The plugin integrates with [Acton](/contract-dev/acton) — a recommended modern all-in-one Tolk smart contract development environment.

<Callout
  type="note"
  title="Older integrations"
>
  [Plugin versions prior to `v4.0.0`](https://plugins.jetbrains.com/plugin/23382-ton/versions/stable/856449) also offer support for:

  - [Blueprint](/contract-dev/blueprint/overview) — comprehensive TypeScript development environment for TON smart contract development
  - [Sandbox](https://github.com/ton-org/sandbox) — local TON emulator

  Since [version `v4.0.0`](https://plugins.jetbrains.com/plugin/23382-ton/versions/stable/1040358), Acton is used as the primary TON development toolchain.
</Callout>
