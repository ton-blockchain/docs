...
<Callout type="note">Sub-second finality is live on TON mainnet.</Callout>
...
<video
  ...
  muted
  loop
  src="/videos/subsecond-example.mov"
...
- Data layer: [TON Center API v3](/api/v3/overview).
...
Use the [public API endpoints overview](/api/overview) for testnet endpoints, including TON Center's streaming endpoints.

### How to get test tokens

For the standard faucet, up to 2 GRAM per hour, [use Telegram Testgiver TON bot](/onboarding/wallet-apps/get-coins#use-testgiver-ton-bot) or [Acton's faucet](https://ton-blockchain.github.io/acton/docs/wallets#fund-a-wallet-on-testnet).
...
- [API overview and public endpoints](/api/overview)
...
[streaming]: /api/streaming/overview
