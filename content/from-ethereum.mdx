...
- On Ethereum, it appears as a single atomic transaction with multiple contract calls inside it. This transaction has a single hash and is included in one block.
  ...
  <Image
    src="/images/from-ethereum/burn-tx-eth-light.png"
    darkSrc="/images/from-ethereum/burn-tx-eth-dark.png"
    alt="ETH burn"
  />
...
- The same operation on TON consists of a sequence of more than 10 transactions. Each arrow on this image represents a distinct finalized transaction, with its own hash, inclusion block, and all the other properties:
  ...
  <Image
    src="/images/from-ethereum/burn-tx-ton-light.png"
    darkSrc="/images/from-ethereum/burn-tx-ton-dark.png"
    alt="GRAM burn"
  />
...
Instead, [sharding](/contracts/techniques/contract-sharding) should be used.

## Ecosystem

### Tooling

The recommended programming language for smart contract development in TON is [Tolk](/tolk/overview). Other established languages also exist and are still used, albeit in legacy status.
...
| :------------------------------------ | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Blockchain interaction                | Ethers, Web3.js, Viem     | [AppKit](/applications/appkit/overview), [`@ton/ton`](https://www.npmjs.com/package/@ton/ton), [Asset-sdk](https://github.com/ton-community/assets-sdk) |
| Wallet connection protocol            | WalletConnect, Wagmi      | [WalletKit](/applications/walletkit/overview) that works on [TON Connect](https://github.com/ton-blockchain/ton-connect)                                |
...
{/* Another library with wrappers for most important contracts and HTTP APIs is [`@ton/ton`](https://www.npmjs.com/package/@ton/ton). */}
...
<Callout type="note">
  There is no web IDE — instead, use the local [Acton toolchain](/contract-dev/acton).
</Callout>
...
| --------------------------------------- | --------------------------------------- | ---------------------------------------------------------------------------- |
| Fungible token standard                 | ERC-20                                  | [Jettons (TEP-0074)](/contracts/standard/tokens/jettons/overview)            |
| Non-fungible token standard             | ERC-721                                 | [NFT standard (TEP-0062)](/contracts/standard/tokens/nft/overview)           |
| Token metadata                          | ERC-4955 (Not exactly, but close match) | [Token Data Standard (TEP-0064)](/contracts/standard/tokens/metadata)        |
| NFT royalty standard                    | EIP-2981                                | [NFT Royalty Standard (TEP-0066)](/contracts/standard/tokens/nft/comparison) |
| DNS-like registry                       | ENS (EIP-137)                           | [DNS Standard (TEP-0081)](/foundations/web3/overview)                        |
| Soulbound / account-bound token concept | EIP-4973                                | [SBT Standard (TEP-0085)](/contracts/standard/tokens/nft/comparison#sbt)     |
