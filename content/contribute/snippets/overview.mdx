...
<Callout type="caution">
  Due to the move from Mintlify to Fumadocs, most descriptions on this and related snippet and components are obsolete. They will be patched up soon, sorry for the inconvenience.
</Callout>
...
All _ad hoc_ snippets are placed in the root `snippets/` folder. For creation and usage details, see the [Mintlify reusable snippets documentation](https://www.mintlify.com/docs/create/reusable-snippets).
...
1. `<Callout>` - use the custom [`<Callout>`](/contribute/snippets/aside) component.
