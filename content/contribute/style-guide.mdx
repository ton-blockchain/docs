...
- Store images under `public/images/` and reference them with root-absolute paths, for example `<Image src="/public/images/<GROUP>/<FILE>.png" />`. **MUST NOT** use relative `src` such as `./` or `../`.
