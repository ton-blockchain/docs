...
- Store images under `public/images/` and reference them with root-absolute paths without the `/public` prefix, for example `<Image src="/images/<GROUP>/<FILE>.png" />`. **MUST NOT** use relative `src` such as `./` or `../`.
