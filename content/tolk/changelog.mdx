...
## [v1.5](https://github.com/ton-blockchain/ton/pull/2577)

1. `@inline` functions with multiple returns
1. `break/continue` in loops
1. Type aliases as directional subtypes
1. Reorganized purity concept and dead-code removal
1. Colorful compilation errors with multiple locations and hints
1. Deprecated `ton("0.05")`. Use `grams("0.05")`
1. Removed the `bytesN` types. Use `bitsN` (`bits512` instead of `bytes64`)
