...
Tolk supports [lambda functions](/tolk/syntax/functions-methods):
...
A callable is backed by the [TVM `CONT`](/tolk/types/overall-tvm-stack). Callable values cannot be [serialized](/tolk/types/overall-serialization).
