...
This page assumes prior knowledge of the [Tolk type system](/tolk/types/list-of-types) and [TVM](/tvm/overview). It serves as a concise low-level reference.
...
- Non-empty maps, `CELL`, have [a non-trivial bit-level layout](/foundations/tlb/complex-and-non-trivial-examples#hashmap).
