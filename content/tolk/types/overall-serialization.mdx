...
This page assumes prior knowledge of the [TL-B](/foundations/tlb/overview) and [TVM](/tvm/overview). It serves as a concise low-level reference.
...
- TL-B: [`HashmapE n X`](/foundations/tlb/complex-and-non-trivial-examples#hashmap)
- Stored using `STDICT`
- Loaded using `LDDICT`
