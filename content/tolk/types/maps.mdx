...
- Prefix dictionaries: `import @stdlib/tvm-dicts` and use [assembly functions](/tolk/features/asm-functions).
...
- An empty map is represented as [TVM `NULL`](/tolk/types/overall-tvm-stack) and is [serialized as `0`](/tolk/types/overall-serialization).
