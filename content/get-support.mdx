...
Use <kbd>Ctrl + K</kbd> to do an indexed search. Supply the `llms.txt` file to an AI agent for accurate context.
...
{/* TODO: ## Security audit firms, agencies, and freelancers
