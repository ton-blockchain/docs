...
- `public = 1` identifies a public library. Only a [special masterchain account](/foundations/config#param-31-fee-exempt-contracts) can add or remove this entry.
