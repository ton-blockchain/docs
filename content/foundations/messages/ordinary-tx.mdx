...
- `destroyed` indicates whether the account was deleted in the action phase by using [`SEND_MODE_DESTROY`](/foundations/messages/modes). If the contract was deleted in the action phase, this flag is `true`.
