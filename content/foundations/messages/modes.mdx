...
|      `128` | <Badge color="red" title="Careless use can result in a total balance loss">Use with caution</Badge> `SEND_MODE_CARRY_ALL_BALANCE` | Send all remaining balance of the account.                                                                |
