...
<Callout type="note">
  Since [global TVM version](/foundations/config#8) 10, [modes 64 and 128 affect only Gram](/foundations/extra-currencies#transfers-and-fees). They do not add extra currencies from the incoming message or account balance.
</Callout>
