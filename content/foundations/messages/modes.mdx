...
<Callout type="note">
  Since [global version 10](/foundations/config#param-8-network-version), [modes 64 and 128 affect only Gram](/foundations/extra-currencies#transfers-and-fees). They do not add extra currencies from the incoming message or account balance.
</Callout>
