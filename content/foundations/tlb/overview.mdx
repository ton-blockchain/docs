---
title: "Type Language - Binary (TL-B)"
sidebarTitle: "Overview"
---

The _Type Language Binary (TL-B)_ is a domain-specific language designed to describe the structure of data in the TON Blockchain.
...
It is recommended to start by studying the [syntax and semantics of TL-B](/foundations/tlb/syntax-and-semantics), simultaneously exploring each example through a convenient [TL-B online editor](https://ton-community.github.io/tlb-editor/#/main). To further your understanding, we recommend referring to [the page](/foundations/tlb/complex-and-non-trivial-examples) that describes the most complex examples of TL-B schemes.
