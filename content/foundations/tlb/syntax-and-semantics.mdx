...
<Image
  src="/images/tlb-scheme.png"
  darkSrc="/images/tlb-scheme-dark.png"
...
For a detailed explanation of how it works, see the [complex and non-trivial examples page](/foundations/tlb/complex-and-non-trivial-examples).
...
For a detailed explanation of how these combinators are deserialized, see the [complex and non-trivial examples page](/foundations/tlb/complex-and-non-trivial-examples).
