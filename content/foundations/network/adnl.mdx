...
The Abstract Datagram Network Layer (_ADNL_) is the core networking protocol of the TON network. It is a peer-to-peer, unreliable datagram protocol that operates over both [UDP](https://en.wikipedia.org/wiki/User_Datagram_Protocol) and [TCP](https://en.wikipedia.org/wiki/Transmission_Control_Protocol).
...
- [ADNL implementation in TON](https://github.com/ton-blockchain/ton/tree/v2026.06/adnl)
