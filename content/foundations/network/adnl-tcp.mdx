...
The `state` field contains a [BoC](/foundations/serialization/boc) with the account's [TL-B structure](https://github.com/ton-blockchain/ton/blob/ad736c6bc3c06ad54dc6e40d62acbaf5dae41584/crypto/block/block.tlb#L232):
...
For a complete parsing walkthrough, see [TL-B documentation](/foundations/tlb/overview).
...
- [TL-B documentation](/foundations/tlb/overview)
