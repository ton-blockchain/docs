...
For a detection how wallets and other applications use these formats, see the [address workflow](/onboarding/wallet-apps/addresses-workflow) page.
...
<Callout>
  The same encoding is used for the so-called armored versions of [public keys](/contracts/techniques/security)
  and ADNL addresses.
</Callout>
