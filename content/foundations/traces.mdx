...
>
  <Image
    src="/images/rpc/trace_def_light.png"
    darkSrc="/images/rpc/trace_def_dark.png"
    alt="Trace diagram"
  />
</div>
...
<Image
  src="/images/rpc/traces_lt_light.png"
  darkSrc="/images/rpc/traces_lt_dark.png"
  alt="Traces with logical time"
/>

## Traces representation in Tonscan

In [Tonscan](https://tonscan.org/), traces are visualized as [directed acyclic graphs (DAGs)](https://en.wikipedia.org/wiki/Directed_acyclic_graph), where _transactions are nodes_ and _messages are edges_, showing the full sequence of account state changes.

## Examples

The NFT transfer illustrates a single operation that consists of multiple messages.

{/* TODO: To learn how to read traces, follow [this article](/explorers/tonviewer#steps-to-read-a-trace). */}

This trace is started with an external message and can be inspected in [Tonscan](https://tonscan.org/tx/47d0989633fc03ff3fdca05880ab5760d0321c196501a6a4cbb5578dea2624cb#details).

{/* TODO: <Image
  src="/images/rpc/nft_transfer_trace_light.png"
  darkSrc="/images/rpc/nft_transfer_trace_dark.png"
...
{/* TODO: <Image
  src="/images/rpc/tick_tock_initiated_trace_light.png"
  darkSrc="/images/rpc/tick_tock_initiated_trace_dark.png"
  alt="Trace initiated by tick-tock transaction"
  /> */}

## Access using API

To fetch traces data, use the [`GET /traces`](/api/v3/actions-and-traces/get-traces) endpoint. This method allows finding a trace if any of its parameters are known.
