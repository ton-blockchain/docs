...
- Storage fees are set in [config parameter 18](/foundations/config#18).
- Compute fees are set in [config parameters 20 and 21](/foundations/config#20-and-21).
- Forward, import, and action fees are set in [config parameters 24 and 25](/foundations/config#24-and-25).
