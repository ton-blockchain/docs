...
Execution cost is first measured in _gas_ units, then converted to Gram. This unit is separate so that if code execution becomes computationally cheaper (or more expensive), validators can vote to change the [price of gas](/foundations/config#20-and-21) in Gram.
