...
| Applications           | Guides on application creation toolsets such as AppKit, TON Pay, WalletKit and TON Connect, as well as guides on monitoring and handling blockchain transactions for business applications, such as [exchanges](https://en.wikipedia.org/wiki/Cryptocurrency_exchange). |
