...
<Aside type="note">
  dApps that need gasless must implement custom signing flows outside TON Connect. Users sign payloads directly via a browser extension or a native app and send them to relayers via HTTPS.
</Aside>
