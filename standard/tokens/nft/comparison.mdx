...
<Aside type="note">
  Some NFT implementations included **obligatory** royalties, which required careful off-chain restrictions and management, thus limiting the distribution and promoting violations.
</Aside>
