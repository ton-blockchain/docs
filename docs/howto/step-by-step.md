...
> Note that the code may contain parameters and methods named gram / nanogram / etc. This is a legacy of the original TON code, the coins of the current TON mainnet are called TON Coins and the coins of the currenct TON testnet are called test TON Coins.
